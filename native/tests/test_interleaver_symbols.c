...
const jm_any_fn jm_bound_symbols_interleaver[] = {
    ...
    (jm_any_fn)dp_interleaver_interleave_max_out,
    (jm_any_fn)dp_interleaver_deinterleave_max_out,
    (jm_any_fn)dp_interleaver_deinterleave_soft_max_out,
    (jm_any_fn)dp_interleaver_interleave,
    (jm_any_fn)dp_interleaver_deinterleave,
    (jm_any_fn)dp_interleaver_deinterleave_soft,
    (jm_any_fn)dp_interleaver_get_burst_len,
    (jm_any_fn)dp_interleaver_get_separation,
};
