...
**Design** — [Design — pure-functional acquisition kernel (elastic fleet)](../design/acq-fn.md), [API taxonomy: the DSP building-block hierarchy and its naming axis](../design/api-taxonomy.md), [BurstBank — the coarse-Doppler bank as one C object](../design/burst-bank.md), [`BurstCapture`: acquisition's output, turned into bursts](../design/burst-capture.md), [`DsssBurstReceiver`: the burst chain, composed in C](../design/dsss-burst-receiver.md), [MPSK Receiver](../design/mpsk.md), [The NCO](../design/nco.md), [Symbol Timing on a Rate Cascade](../design/ratesync-timing.md), [State Serialization — the standard bytes interface](../design/state-serialization.md)
