...
inline void *
atomic_xchg_ptr (void **ptr_, void *const val_
#if defined ZMQ_ATOMIC_PTR_MUTEX
                 ,
                 mutex_t &_sync
#endif
...
inline void *
atomic_cas (void *volatile *ptr_, void *cmp_, void *val_
#if defined ZMQ_ATOMIC_PTR_MUTEX
            ,
            mutex_t &_sync
#endif
...
public:
  ...
  //  is returned.
  T *
  cas (T *cmp_, T *val_) ZMQ_NOEXCEPT
  {
#if defined ZMQ_ATOMIC_PTR_CXX11
...
struct atomic_value_t
{
  ...
  void
  store (const int value_) ZMQ_NOEXCEPT
  {
#if defined ZMQ_ATOMIC_PTR_CXX11
