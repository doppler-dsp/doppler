...
void
zmq::scatter_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::scatter_t::xwrite_activated (pipe_t *pipe_)
{
  _lb.activated (pipe_);
}

void
zmq::scatter_t::xpipe_terminated (pipe_t *pipe_)
{
  _lb.pipe_terminated (pipe_);
}

int
zmq::scatter_t::xsend (msg_t *msg_)
{
