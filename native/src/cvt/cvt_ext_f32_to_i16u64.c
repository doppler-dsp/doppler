 ...
 */
/* ======================================================== */
/* F32ToI16U64Object — wraps dp_f32_to_i16u64_state_t *       */
/* ======================================================== */
...
typedef struct
{
  PyObject_HEAD dp_f32_to_i16u64_state_t *handle;
} F32ToI16U64Object;
...
{
  if (self->handle)
    dp_f32_to_i16u64_destroy (self->handle);
...
F32ToI16U64Obj_init (F32ToI16U64Object *self, PyObject *args, PyObject *kwds)
{
  ...
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "|f", kwlist, &scale))
    return -1;
  self->handle = dp_f32_to_i16u64_create (scale);
  if (!self->handle)
    {
      PyErr_SetString (PyExc_MemoryError,
                       "dp_f32_to_i16u64_create returned NULL");
      return -1;
    }
  return 0;
}
...
F32ToI16U64Obj_reset (F32ToI16U64Object *self, PyObject *Py_UNUSED (ignored))
{
  ...
  dp_f32_to_i16u64_reset (self->handle);
  Py_RETURN_NONE;
}
...
F32ToI16U64_step (F32ToI16U64Object *self, PyObject *args)
{
  ...
  if (!PyArg_ParseTuple (args, "f", &x))
    return NULL;
  uint64_t y = dp_f32_to_i16u64_step (self->handle, x);
...
F32ToI16U64_steps (F32ToI16U64Object *self, PyObject *args, PyObject *kwds)
{
  ...
  if (out_obj && out_obj != Py_None)
    {
      ...
      dp_f32_to_i16u64_steps (self->handle,
  ...
  dp_f32_to_i16u64_steps (self->handle, (const float *)PyArray_DATA (in_arr),
                            ...
                            PyObject          *Py_UNUSED (ignored))
{
  ...
  return PyLong_FromSize_t (dp_f32_to_i16u64_state_bytes (self->handle));
}
                          ...
                          PyObject          *Py_UNUSED (ignored))
{
  ...
  size_t    _n = dp_f32_to_i16u64_state_bytes (self->handle);
  PyObject *_b = PyBytes_FromStringAndSize (NULL, (Py_ssize_t)_n);
  if (!_b)
    return NULL;
  dp_f32_to_i16u64_get_state (self->handle, PyBytes_AS_STRING (_b));
  return _b;
}
...
F32ToI16U64Obj_set_state (F32ToI16U64Object *self, PyObject *arg)
{
  ...
  if ((size_t)PyBytes_GET_SIZE (arg)
      != dp_f32_to_i16u64_state_bytes (self->handle))
    {
      PyErr_SetString (PyExc_ValueError, "state blob size mismatch");
      return NULL;
    }
  if (dp_f32_to_i16u64_set_state (self->handle, PyBytes_AS_STRING (arg)) != 0)
    {
