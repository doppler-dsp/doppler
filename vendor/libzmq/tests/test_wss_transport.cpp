...
const char *key
    = "-----BEGIN PRIVATE KEY-----\n"
      ...
      "ueMI5uzmSk+3dp5vRUQhdkKKIgbpep00Ucc2a2pPhkrnXFJ5UvmXdpip0+AXAZ9h\n"
...
const char *cert
    = "-----BEGIN CERTIFICATE-----\n"
      ...
      "CJhgQZkiHLvhfZ0quJrqEJwBh1L7/3Sd/REDLKdpIO2BMaswhcWaOVikueCp8Cj7\n"
      ...
      "A4ICAQB9M5p9z92UhVXg2baUj9QBN2YFGdpveFRpZ9Y/wktEssTqMKkc+39UtfJS\n"
      "UclZnzMEhLyTieNqf+8GCgLLI0YSTIJpWwzvQBcXPoo+8IcexANvxR22KZrE51y4\n"
      "/YfCKh8Q0ZbG8oc5Br8YHwipzGcmWjWtznfMpudpLezv/r381QV1Sbmpw2a0jvwp\n"
