...
static PyObject *
F32ToI16U32_steps(F32ToI16U32Object *self, PyObject *args)
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "destroyed");
        return NULL;
...
static PyObject *
F32ToI16U32Obj_get_clipped(F32ToI16U32Object *self, void *Py_UNUSED(closure))
{
    if (!self->handle) {
        PyErr_SetString(PyExc_RuntimeError, "destroyed");
        return NULL;
...
static PyGetSetDef F32ToI16U32Obj_getset[] = {
    {"clipped",
     (getter)F32ToI16U32Obj_get_clipped, NULL,
...
static PyTypeObject F32ToI16U32ObjType = {
    ...
    .tp_getset    = F32ToI16U32Obj_getset,
