/* test_ddc_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_ddc[];
...
const jm_any_fn jm_bound_symbols_ddc[] = {
    (jm_any_fn)ddc_create,
    (jm_any_fn)ddc_create_matched,
    (jm_any_fn)ddc_destroy,
    (jm_any_fn)ddc_reset,
    (jm_any_fn)ddc_get_norm_freq,
    (jm_any_fn)ddc_set_norm_freq,
    (jm_any_fn)ddc_get_rate,
    (jm_any_fn)ddc_execute,
    (jm_any_fn)ddc_execute_ctrl,
    (jm_any_fn)ddc_execute_ctrl_push,
    (jm_any_fn)ddc_get_narrow_pulse,
    (jm_any_fn)ddc_get_clipped,
    (jm_any_fn)ddc_execute_max_out,
    (jm_any_fn)ddc_state_bytes,
    (jm_any_fn)ddc_get_state,
    (jm_any_fn)ddc_set_state,
    (jm_any_fn)ddc_execute_ctrl_max_out,
    (jm_any_fn)ddc_execute_ctrl_push_max_out,
};
