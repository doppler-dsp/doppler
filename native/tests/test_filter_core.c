/* test_filter_core.c — smoke test for the filter module's
 * free functions.
 *
...
#define JM_TEST_NAME "test_filter_core"
...
main (void)
{
  /* TODO: design_lowpass(...) writes into a caller-sized output buffer jm
