/* test_ddcr_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_ddcr[];
...
const jm_any_fn jm_bound_symbols_ddcr[] = {
    (jm_any_fn)ddcr_create,
    (jm_any_fn)ddcr_create_matched,
    (jm_any_fn)ddcr_destroy,
    (jm_any_fn)ddcr_reset,
    (jm_any_fn)ddcr_state_bytes,
    (jm_any_fn)ddcr_get_state,
    (jm_any_fn)ddcr_set_state,
    (jm_any_fn)ddcr_get_norm_freq,
    (jm_any_fn)ddcr_set_norm_freq,
    (jm_any_fn)ddcr_get_rate,
    (jm_any_fn)ddcr_execute,
    (jm_any_fn)ddcr_execute_max_out,
    (jm_any_fn)ddcr_execute_ctrl_max_out,
    (jm_any_fn)ddcr_execute_ctrl_push_max_out,
    (jm_any_fn)ddcr_execute_ctrl,
    (jm_any_fn)ddcr_execute_ctrl_push,
    (jm_any_fn)ddcr_get_narrow_pulse,
    (jm_any_fn)ddcr_get_clipped,
};
