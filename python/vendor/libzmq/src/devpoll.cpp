...
void
zmq::devpoll_t::devpoll_ctl (fd_t fd_, short events_)
{
...
zmq::devpoll_t::handle_t
zmq::devpoll_t::add_fd (fd_t fd_, i_poll_events *reactor_)
{
  check_thread ();
...
void
zmq::devpoll_t::rm_fd (handle_t handle_)
{
  check_thread ();
...
void
zmq::devpoll_t::set_pollin (handle_t handle_)
{
  check_thread ();
  devpoll_ctl (handle_, POLLREMOVE);
...
void
zmq::devpoll_t::reset_pollin (handle_t handle_)
{
  check_thread ();
  devpoll_ctl (handle_, POLLREMOVE);
...
void
zmq::devpoll_t::set_pollout (handle_t handle_)
{
  check_thread ();
  devpoll_ctl (handle_, POLLREMOVE);
...
void
zmq::devpoll_t::reset_pollout (handle_t handle_)
{
  check_thread ();
  devpoll_ctl (handle_, POLLREMOVE);
