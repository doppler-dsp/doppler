...
{
  static char *kwlist[]
      = { "window", "mode", "n", "fs", "beta", "alpha", NULL };
  ...
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "|ssKdfd", kwlist, &window_str,
                                    &mode_str, &n_raw, &fs, &beta, &alpha))
    return -1;
  int window = 0;
  ...
  self->handle = welch_create (n, fs, window, beta, mode, alpha);
  if (!self->handle)
    {
...
static PyObject *
WelchObj_accumulate (WelchObject *self, PyObject *args)
{
  if (!self->handle)
    {
...
static PyObject *
WelchObj_psd_db (WelchObject *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
  ...
  if (!self->_psd_db_buf || self->_psd_db_buf_cap < _need)
    {
      ...
      if (!_max || _max < _need)
        _max = _need;
      float *_tmp = realloc (self->_psd_db_buf, _max * sizeof (float));
      if (!_tmp)
        {
          PyErr_NoMemory ();
          return NULL;
...
static PyObject *
WelchObj_psd_dbhz (WelchObject *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
  ...
  if (!self->_psd_dbhz_buf || self->_psd_dbhz_buf_cap < _need)
    {
      ...
      if (!_max || _max < _need)
        _max = _need;
      float *_tmp = realloc (self->_psd_dbhz_buf, _max * sizeof (float));
      if (!_tmp)
        {
          PyErr_NoMemory ();
          return NULL;
  ...
  if (!self->_band_power_buf || self->_band_power_buf_cap < _need)
    {
      ...
      if (!_max || _max < _need)
        _max = _need;
      float *_tmp = realloc (self->_band_power_buf, _max * sizeof (float));
      if (!_tmp)
        {
          Py_DECREF (bands_arr);
          PyErr_NoMemory ();
...
static PyObject *
WelchObj_total_band_power (WelchObject *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
WelchObj_occupied_bw (WelchObject *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
WelchObj_snr (WelchObject *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
  ...
  double lo_hz = 0.0;
  double hi_hz = 0.0;
  if (!PyArg_ParseTuple (args, "dd", &lo_hz, &hi_hz))
    return NULL;
...
static PyObject *
WelchObj_sfdr (WelchObject *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
  ...
  float min_db = 0.0f;
  if (!PyArg_ParseTuple (args, "f", &min_db))
    return NULL;
...
static PyMethodDef WelchObj_methods[] = {
  ...
  { "accumulate", (PyCFunction)WelchObj_accumulate, METH_VARARGS,
    "accumulate(x) -> None\n"
    "\n"
    ...
    "    >>> obj = Welch(\"hann\", \"mean\", 1024, 1.0, 0.0, 0.1)\n"
  ...
  { "reset", (PyCFunction)WelchObj_reset, METH_NOARGS,
    ...
    "    >>> obj = Welch(\"hann\", \"mean\", 1024, 1.0, 0.0, 0.1)\n"
    "    >>> obj.reset()\n" },
  { "psd_db", (PyCFunction)WelchObj_psd_db, METH_VARARGS,
    "psd_db(n=1) -> ndarray\n"
    "\n"
    ...
    "    >>> y.dtype\n"
    "    dtype('float32')\n" },
  { "psd_dbhz", (PyCFunction)WelchObj_psd_dbhz, METH_VARARGS,
  ...
  { "band_power", (PyCFunction)WelchObj_band_power, METH_VARARGS,
    ...
    "    >>> y.dtype\n"
    "    dtype('float32')\n" },
  { "total_band_power", (PyCFunction)WelchObj_total_band_power, METH_VARARGS,
    ...
    "    0.0\n" },
  { "occupied_bw", (PyCFunction)WelchObj_occupied_bw, METH_VARARGS,
  ...
  { "noise_floor", (PyCFunction)WelchObj_noise_floor, METH_NOARGS,
    ...
    "    >>> obj.noise_floor()\n"
    "    0.0\n" },
  { "snr", (PyCFunction)WelchObj_snr, METH_VARARGS,
    ...
    "    >>> obj.snr(0.0, 0.0)\n"
    "    0.0\n" },
  { "sfdr", (PyCFunction)WelchObj_sfdr, METH_VARARGS,
    "sfdr(min_db) -> float\n"
    "\n"
