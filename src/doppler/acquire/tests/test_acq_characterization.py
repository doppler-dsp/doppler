"""Performance-characterisation gate for ``doppler.acquire.BurstAcquisition``.
...
from doppler.acquire.tests.characterization.burst_acquisition.characterize import (  # noqa: E501
    ACQ_CODE,
    ACQ_REPS,
    CHIP_RATE,
    DATA_SF,
