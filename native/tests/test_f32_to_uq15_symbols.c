/* test_f32_to_uq15_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_f32_to_uq15[];
...
const jm_any_fn jm_bound_symbols_f32_to_uq15[] = {
  (jm_any_fn)f32_to_uq15_create,      (jm_any_fn)f32_to_uq15_destroy,
  (jm_any_fn)f32_to_uq15_reset,       (jm_any_fn)f32_to_uq15_steps,
  (jm_any_fn)f32_to_uq15_state_bytes, (jm_any_fn)f32_to_uq15_get_state,
