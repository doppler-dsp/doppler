...
void
zmq::radio_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::radio_t::xread_activated (pipe_t *pipe_)
{
...
void
zmq::radio_t::xwrite_activated (pipe_t *pipe_)
{
  _dist.activated (pipe_);
}
int
zmq::radio_t::xsetsockopt (int option_, const void *optval_, size_t optvallen_)
{
...
void
zmq::radio_t::xpipe_terminated (pipe_t *pipe_)
{
...
zmq::radio_t::xsend (msg_t *msg_)
{
  ...
  const std::pair<subscriptions_t::iterator, subscriptions_t::iterator> range
  ...
  for (udp_pipes_t::iterator it = _udp_pipes.begin (), end = _udp_pipes.end ();
       it != end; ++it)
    _dist.match (*it);
...
int
zmq::radio_session_t::push_msg (msg_t *msg_)
{
...
int
zmq::radio_session_t::pull_msg (msg_t *msg_)
{
  if (_state == group)
    {
