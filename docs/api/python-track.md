...
**Design** — [API taxonomy: the DSP building-block hierarchy and its naming axis](../design/api-taxonomy.md), [Asynchronous symbol/code despreading](../design/async-symbol-despreader.md), [MPSK Receiver](../design/mpsk.md), [State Serialization — the standard bytes interface](../design/state-serialization.md), [SymbolSync Timing Lock Detector](../design/timing_lock_detector.md)
