...
# Struct dp\_farrow\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_farrow\_state\_t**](structdp__farrow__state__t.md)
...
```C++
float _Complex dp_farrow_state_t::d[4];
```
