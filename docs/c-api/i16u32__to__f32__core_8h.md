...
[**FileList**](files.md) **>** [**doppler**](dir_c8eead50fa73fbaea26b38d49c33a8a7.md) **>** [**i16u32\_to\_f32**](dir_c1ecd6bb977db755472db2284b0a6806.md) **>** [**i16u32\_to\_f32\_core.h**](i16u32__to__f32__core_8h.md)
...
| Type | Name |
| ---: | :--- |
| struct | [**dp\_i16u32\_to\_f32\_state\_t**](structdp__i16u32__to__f32__state__t.md) <br>_I16U32ToF32 state._  |
...
| Type | Name |
| ---: | :--- |
|  [**dp\_i16u32\_to\_f32\_state\_t**](structdp__i16u32__to__f32__state__t.md) \* | [**dp\_i16u32\_to\_f32\_create**](#function-dp_i16u32_to_f32_create) (float scale) <br>_Create a i16u32\_to\_f32 instance._  |
|  void | [**dp\_i16u32\_to\_f32\_destroy**](#function-dp_i16u32_to_f32_destroy) ([**dp\_i16u32\_to\_f32\_state\_t**](structdp__i16u32__to__f32__state__t.md) \* state) <br>_Destroy a i16u32\_to\_f32 instance and release all memory._  |
|  void | [**dp\_i16u32\_to\_f32\_reset**](#function-dp_i16u32_to_f32_reset) ([**dp\_i16u32\_to\_f32\_state\_t**](structdp__i16u32__to__f32__state__t.md) \* state) <br>_No-op reset, provided only for lifecycle symmetry._  |
|  [**JM\_FORCEINLINE**](jm__perf_8h.md#define-jm_forceinline) [**JM\_HOT**](jm__perf_8h.md#define-jm_hot) float | [**dp\_i16u32\_to\_f32\_step**](#function-dp_i16u32_to_f32_step) (const [**dp\_i16u32\_to\_f32\_state\_t**](structdp__i16u32__to__f32__state__t.md) \* state, uint32\_t x) <br>_Unpack a Q15 code from a uint32's low 16 bits to a normalised float._  |
|  void | [**dp\_i16u32\_to\_f32\_steps**](#function-dp_i16u32_to_f32_steps) ([**dp\_i16u32\_to\_f32\_state\_t**](structdp__i16u32__to__f32__state__t.md) \* state, const uint32\_t \* input, float \* output, size\_t n) <br>_Process a block of Q15-in-uint32 samples to float32._  |
...
### function dp\_i16u32\_to\_f32\_create 

_Create a i16u32\_to\_f32 instance._ 
```C++
dp_i16u32_to_f32_state_t * dp_i16u32_to_f32_create (
    float scale
) 
```
...
Caller must call [**dp\_i16u32\_to\_f32\_destroy()**](i16u32__to__f32__core_8h.md#function-dp_i16u32_to_f32_destroy) when done. 
...
### function dp\_i16u32\_to\_f32\_destroy 

_Destroy a i16u32\_to\_f32 instance and release all memory._ 
```C++
void dp_i16u32_to_f32_destroy (
...
### function dp\_i16u32\_to\_f32\_reset 

_No-op reset, provided only for lifecycle symmetry._ 
```C++
void dp_i16u32_to_f32_reset (
    dp_i16u32_to_f32_state_t * state
) 
```
...
### function dp\_i16u32\_to\_f32\_step 

_Unpack a Q15 code from a uint32's low 16 bits to a normalised float._ 
```C++
JM_FORCEINLINE  JM_HOT float dp_i16u32_to_f32_step (
    const dp_i16u32_to_f32_state_t * state,
    uint32_t x
) 
```
...
### function dp\_i16u32\_to\_f32\_steps 
...
------------------------------
The documentation for this class was generated from the following file `native/inc/doppler/i16u32_to_f32/i16u32_to_f32_core.h`
