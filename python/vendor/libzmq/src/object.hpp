...
protected:
  ...
  void pend_connection (const std::string &addr_, const endpoint_t &endpoint_,
                        pipe_t **pipes_);
  ...
  void send_attach (zmq::session_base_t *destination_, zmq::i_engine *engine_,
                    bool inc_seqnum_ = true);
  ...
  void send_pipe_peer_stats (zmq::pipe_t *destination_, uint64_t queue_count_,
