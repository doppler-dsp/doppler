...
static PyTypeObject dpMsgType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "dp_stream._dpMsg",
...
static PyTypeObject PublisherType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "dp_stream.Publisher",
...
static PyTypeObject SubscriberType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "dp_stream.Subscriber",
...
static PyTypeObject PushType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "dp_stream.Push",
...
static PyTypeObject PullType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "dp_stream.Pull",
...
static PyTypeObject RequesterType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "dp_stream.Requester",
...
static PyTypeObject ReplierType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "dp_stream.Replier",
