...
static PyMethodDef AGCObj_methods[] = {
  ...
  { "set_telemetry", (PyCFunction)(void *)AGCObj_set_telemetry,
    ...
    "it. Registers two probes, both recorded once per gain-update event and "
    ...
    "\n"
    "The pair is emitted from one update, with level_db being the belief that "
    "update was answering (measured before the correction is applied).  "
    "Passing NULL detaches (probe sites "
