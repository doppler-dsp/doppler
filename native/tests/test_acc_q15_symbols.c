...
const jm_any_fn jm_bound_symbols_acc_q15[] = {
  (jm_any_fn)acc_q15_create,    (jm_any_fn)acc_q15_destroy,
  (jm_any_fn)acc_q15_reset,     (jm_any_fn)acc_q15_steps,
  (jm_any_fn)acc_q15_get_acc,   (jm_any_fn)acc_q15_set_acc,
  (jm_any_fn)acc_q15_get,       (jm_any_fn)acc_q15_dump,
  (jm_any_fn)acc_q15_madd,      (jm_any_fn)acc_q15_state_bytes,
  (jm_any_fn)acc_q15_get_state, (jm_any_fn)acc_q15_set_state,
};
