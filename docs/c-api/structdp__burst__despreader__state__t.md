...
# Struct dp\_burst\_despreader\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_burst\_despreader\_state\_t**](structdp__burst__despreader__state__t.md)
...
|  [**dp\_loop\_filter\_state\_t**](structdp__loop__filter__state__t.md) | [**lf\_car**](#variable-lf_car)  <br> |
|  [**dp\_loop\_filter\_state\_t**](structdp__loop__filter__state__t.md) | [**lf\_code**](#variable-lf_code)  <br> |
...
Allocate with [**dp\_burst\_despreader\_create()**](burst__despreader__core_8h.md#function-dp_burst_despreader_create). 
...
```C++
float _Complex dp_burst_despreader_state_t::acc_e;
```
...
```C++
float _Complex dp_burst_despreader_state_t::acc_l;
```
...
```C++
float _Complex dp_burst_despreader_state_t::acc_p;
```
...
```C++
uint8_t* dp_burst_despreader_state_t::acq_code;
```
...
```C++
size_t dp_burst_despreader_state_t::acq_reps;
```
...
```C++
size_t dp_burst_despreader_state_t::acq_sf;
```
...
```C++
double dp_burst_despreader_state_t::car_phase;
```
...
```C++
double dp_burst_despreader_state_t::car_w;
```
...
```C++
double dp_burst_despreader_state_t::chip_pos;
```
...
```C++
uint8_t* dp_burst_despreader_state_t::code;
```
...
```C++
double dp_burst_despreader_state_t::code_rate;
```
...
```C++
dp_loop_filter_state_t dp_burst_despreader_state_t::lf_car;
```
...
```C++
dp_loop_filter_state_t dp_burst_despreader_state_t::lf_code;
```
...
```C++
double dp_burst_despreader_state_t::lock_metric;
```
...
```C++
size_t dp_burst_despreader_state_t::preamble_left;
```
...
```C++
double dp_burst_despreader_state_t::seed_chip;
```
...
```C++
double dp_burst_despreader_state_t::seed_w;
```
...
```C++
size_t dp_burst_despreader_state_t::sf;
```
...
```C++
double dp_burst_despreader_state_t::snr_est;
```
...
```C++
size_t dp_burst_despreader_state_t::sps;
```
...
```C++
size_t dp_burst_despreader_state_t::stat_n;
```
...
```C++
double dp_burst_despreader_state_t::sum_im2;
```
...
```C++
double dp_burst_despreader_state_t::sum_lock;
```
...
```C++
double dp_burst_despreader_state_t::sum_re2;
```
...
```C++
size_t dp_burst_despreader_state_t::tsamps;
```
