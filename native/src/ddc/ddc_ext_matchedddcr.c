...
static PyMethodDef MatchedDdcrObj_methods[] = {
  ...
  { "state_bytes", (PyCFunction)MatchedDdcrObj_state_bytes, METH_NOARGS,
    ...
    "constant.\n"
    "\n"
    "Raises ``RuntimeError`` if the MatchedDdcrObj has already been\n"
    "destroyed.\n"
    "\n"
    "Returns\n"
    "-------\n"
  ...
  { "set_state", (PyCFunction)MatchedDdcrObj_set_state, METH_O,
    ...
    "``RuntimeError`` if the MatchedDdcrObj has already been destroyed.\n"
    "\n"
    "Parameters\n"
    "----------\n"
    "blob : bytes\n"
  ...
  { "__exit__", (PyCFunction)MatchedDdcrObj_exit, METH_VARARGS,
