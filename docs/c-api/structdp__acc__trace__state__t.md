...
# Struct dp\_acc\_trace\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_acc\_trace\_state\_t**](structdp__acc__trace__state__t.md)



_AccTrace state. Allocate with_ [_**dp\_acc\_trace\_create()**_](acc__trace__core_8h.md#function-dp_acc_trace_create) _._
...
```C++
double* dp_acc_trace_state_t::acc;
```
...
```C++
double dp_acc_trace_state_t::alpha;
```
...
```C++
uint64_t dp_acc_trace_state_t::count;
```
...
```C++
acc_trace_mode_t dp_acc_trace_state_t::mode;
```
