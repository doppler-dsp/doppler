...
# Struct dp\_mpsk\_receiver\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_mpsk\_receiver\_state\_t**](structdp__mpsk__receiver__state__t.md)
...
| Type | Name |
| ---: | :--- |
|  [**dp\_ddc\_state\_t**](ddc__core_8h.md#typedef-dp_ddc_state_t) \* | [**c**](#variable-c)  <br> |
|  double | [**centre\_freq**](#variable-centre_freq)  <br> |
|  union [**dp\_mpsk\_receiver\_state\_t**](structdp__mpsk__receiver__state__t.md) | [**fe**](#variable-fe)  <br> |
|  [**mpsk\_rx\_loops\_t**](structmpsk__rx__loops__t.md) | [**l**](#variable-l)  <br> |
|  [**dp\_ddcr\_state\_t**](ddcr__core_8h.md#typedef-dp_ddcr_state_t) \* | [**r**](#variable-r)  <br> |
...
```C++
dp_ddc_state_t* dp_mpsk_receiver_state_t::c;
```
...
```C++
double dp_mpsk_receiver_state_t::centre_freq;
```
...
```C++
union dp_mpsk_receiver_state_t dp_mpsk_receiver_state_t::fe;
```
...
```C++
mpsk_rx_loops_t dp_mpsk_receiver_state_t::l;
```
...
```C++
dp_ddcr_state_t* dp_mpsk_receiver_state_t::r;
```
...
```C++
int dp_mpsk_receiver_state_t::real;
```
