...
| FFT | [`fft/fft_core.h`](fft__core_8h.md) | 1-D FFT; pocketfft backend |
| FFT 2D | [`fft2d/fft2d_core.h`](fft2d__core_8h.md) | 2-D FFT |
| Correlation | [`corr/corr_core.h`](corr__core_8h.md) | 1-D FFT cross-correlator with integrate-and-dump |
| Correlation 2D | [`corr2d/corr2d_core.h`](corr2d__core_8h.md) | 2-D FFT cross-correlator with integrate-and-dump |
| Detector | [`detector/detector_core.h`](detector__core_8h.md) | Streaming CFAR signal detector (1-D) |
| Detector 2D | [`detector2d/detector2d_core.h`](detector2d__core_8h.md) | Streaming CFAR signal detector (2-D) |
| Detection | [`detection/detection_core.h`](detection__core_8h.md) | Marcum Q, thresholds, Pd, dwell, SNR functions |
...
| Ring buffer | [`dp/buffer.h`](buffer_8h.md) | Double-mapped ring buffers, lock-free SPSC |
...
|-------|--------|-------------|
| Wire protocol | [`dp/stream.h`](stream_8h.md) | `dp_header_t`, magic, PUB/SUB, PUSH/PULL, REQ/REP |
