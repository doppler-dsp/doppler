...
|  int | [**dp\_pub\_send\_eos**](#function-dp_pub_send_eos) ([**dp\_pub\_t**](group__types.md#typedef-dp_pub_t) \* ctx) <br>_Tell subscribers the stream has ended._  |
...
_Tell subscribers the stream has ended._ 
```
int dp_pub_send_eos (
    dp_pub_t * ctx
) 
