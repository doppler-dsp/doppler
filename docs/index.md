...
maximum throughput with minimum friction. The full DSP stack lives in
one portable C core with paper-thin Python bindings and a Rust FFI —
consumable from any language via the C ABI.
