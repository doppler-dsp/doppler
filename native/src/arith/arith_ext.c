...
static PyMethodDef arith_module_methods[] = {
  { "add_q15", (PyCFunction)(void *)_bind_add_q15,
    ...
    ">>> add_q15(a, b).tolist()\n"
    "[150, 32767, -32768]\n" },
  { "sub_q15", (PyCFunction)(void *)_bind_sub_q15,
    METH_VARARGS | METH_KEYWORDS,
    ...
    ">>> sub_q15(a, b).tolist()\n"
    "[50, 0, -32768]\n" },
  { "mul_q15", (PyCFunction)(void *)_bind_mul_q15,
    METH_VARARGS | METH_KEYWORDS,
    ...
    ">>> mul_q15(a, b).tolist()\n"
    "[8192, -8192, 32766]\n" },
  { "dot_q15", (PyCFunction)(void *)_bind_dot_q15,
    METH_VARARGS | METH_KEYWORDS,
    ...
    ">>> dot_q15(a, b)\n"
    "1400\n" },
  { "shl_q15", (PyCFunction)(void *)_bind_shl_q15,
    METH_VARARGS | METH_KEYWORDS,
    ...
    ">>> shl_q15(a, 1).tolist()\n"
    "[16384, 32767, 32767]\n" },
  { "shr_q15", (PyCFunction)(void *)_bind_shr_q15,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "shr_q8", (PyCFunction)(void *)_bind_shr_q8, METH_VARARGS | METH_KEYWORDS,
    ...
    ">>> shr_q8(a, 2).tolist()\n"
    "[3, 3, 3, -2]\n" },
  { "shl_i64", (PyCFunction)(void *)_bind_shl_i64,
    METH_VARARGS | METH_KEYWORDS,
    ...
    ">>> shl_i64(a, 3).tolist()\n"
    "[800, 1600, -1600]\n" },
  { "shr_i64", (PyCFunction)(void *)_bind_shr_i64,
    METH_VARARGS | METH_KEYWORDS,
...
static PyModuleDef arith_moduledef = {
  ...
  .m_name = "arith",
  .m_doc  = "Fixed-point accumulators: Q8 and Q15 scalar sums (AccQ8, AccQ15) "
            "with exact integer arithmetic for bit-true pipelines.\n"
            "\n"
            "Examples\n"
            "--------\n"
...
{
  import_array ();
  if (PyType_Ready (&AccQ15Type) < 0)
    return NULL;
  if (PyType_Ready (&AccQ8Type) < 0)
    return NULL;
