...
zmq::lb_t::lb_t ()
    : _active (0), _current (0), _more (false), _dropping (false)
{
}
...
void
zmq::lb_t::pipe_terminated (pipe_t *pipe_)
{
...
void
zmq::lb_t::activated (pipe_t *pipe_)
{
...
int
zmq::lb_t::send (msg_t *msg_)
{
  return sendpipe (msg_, NULL);
}

int
zmq::lb_t::sendpipe (msg_t *msg_, pipe_t **pipe_)
{
