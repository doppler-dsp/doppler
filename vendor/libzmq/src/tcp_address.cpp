...
int
zmq::tcp_address_t::resolve (const char *name_, bool local_, bool ipv6_)
{
...
static std::string
make_address_string (const char *hbuf_, uint16_t port_,
...
int
zmq::tcp_address_t::to_string (std::string &addr_) const
{
...
int
zmq::tcp_address_mask_t::resolve (const char *name_, bool ipv6_)
{
...
bool
zmq::tcp_address_mask_t::match_address (const struct sockaddr *ss_,
