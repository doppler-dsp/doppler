...
void
zmq::kqueue_t::kevent_add (fd_t fd_, short filter_, void *udata_)
{
  check_thread ();
  struct kevent ev;
...
void
zmq::kqueue_t::kevent_delete (fd_t fd_, short filter_)
{
  struct kevent ev;
...
zmq::kqueue_t::handle_t
zmq::kqueue_t::add_fd (fd_t fd_, i_poll_events *reactor_)
{
  check_thread ();
...
void
zmq::kqueue_t::rm_fd (handle_t handle_)
{
  check_thread ();
...
void
zmq::kqueue_t::reset_pollin (handle_t handle_)
{
  check_thread ();
  poll_entry_t *pe = (poll_entry_t *)handle_;
  if (likely (pe->flag_pollin))
...
void
zmq::kqueue_t::set_pollout (handle_t handle_)
{
  check_thread ();
  poll_entry_t *pe = (poll_entry_t *)handle_;
...
void
zmq::kqueue_t::reset_pollout (handle_t handle_)
{
  check_thread ();
  poll_entry_t *pe = (poll_entry_t *)handle_;
  if (likely (pe->flag_pollout))
