...
const jm_any_fn jm_bound_symbols_wfm_synth[] = {
    ...
    (jm_any_fn)dp_wfm_synth_destroy,
    (jm_any_fn)dp_wfm_synth_reset,
    (jm_any_fn)dp_wfm_synth_steps,
    (jm_any_fn)dp_wfm_synth_get_wtype,
    (jm_any_fn)dp_wfm_synth_set_wtype,
    (jm_any_fn)dp_wfm_synth_get_nsps,
    (jm_any_fn)dp_wfm_synth_set_nsps,
    (jm_any_fn)dp_wfm_synth_get_sym_pos,
    (jm_any_fn)dp_wfm_synth_set_sym_pos,
    (jm_any_fn)dp_wfm_synth_get_cur_re,
    (jm_any_fn)dp_wfm_synth_set_cur_re,
    (jm_any_fn)dp_wfm_synth_get_cur_im,
    (jm_any_fn)dp_wfm_synth_set_cur_im,
    (jm_any_fn)dp_wfm_synth_state_bytes,
    (jm_any_fn)dp_wfm_synth_get_state,
    (jm_any_fn)dp_wfm_synth_set_state,
};
