...
int
zmq::plain_client_t::next_handshake_command (msg_t *msg_)
{
  int rc = 0;
...
int
zmq::plain_client_t::process_handshake_command (msg_t *msg_)
{
...
void
zmq::plain_client_t::produce_hello (msg_t *msg_) const
{
...
int
zmq::plain_client_t::process_welcome (const unsigned char *cmd_data_,
                                      size_t data_size_)
{
...
void
zmq::plain_client_t::produce_initiate (msg_t *msg_) const
{
...
int
zmq::plain_client_t::process_ready (const unsigned char *cmd_data_,
                                    size_t data_size_)
{
...
int
zmq::plain_client_t::process_error (const unsigned char *cmd_data_,
                                    size_t data_size_)
{
