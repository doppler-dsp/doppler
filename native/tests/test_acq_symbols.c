...
const jm_any_fn jm_bound_symbols_acq[] = {
    ...
    (jm_any_fn)dp_acq_set_max_peaks,
    (jm_any_fn)dp_acq_set_carrier_freq_hz,
    (jm_any_fn)dp_acq_set_threads,
    (jm_any_fn)dp_acq_set_telemetry,
    (jm_any_fn)dp_acq_surface,
    (jm_any_fn)dp_acq_surface_doppler_hz,
    (jm_any_fn)dp_acq_surface_chip_phase,
    (jm_any_fn)dp_acq_surface_complex,
    (jm_any_fn)dp_acq_block_prompt,
    (jm_any_fn)dp_acq_block_raw,
    (jm_any_fn)dp_acq_push,
    (jm_any_fn)dp_acq_state_bytes,
    (jm_any_fn)dp_acq_get_state,
    (jm_any_fn)dp_acq_set_state,
};
