...
public:
  ...
  ws_connecter_t (zmq::io_thread_t *io_thread_, zmq::session_base_t *session_,
                  const options_t &options_, address_t *addr_,
                  bool delayed_start_, bool wss_,
...
private:
  //  ID of the timer used to check the connect timeout, must be different from
  //  stream_connecter_base_t::reconnect_timer_id.
  enum
  {
    connect_timer_id = 2
  };
