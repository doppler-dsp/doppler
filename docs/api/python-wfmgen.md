...
**Design** — [API taxonomy: the DSP building-block hierarchy and its naming axis](../design/api-taxonomy.md), [DsssReceiver Specifications](../design/async-dsss-spec.md), [BurstBank — the coarse-Doppler bank as one C object](../design/burst-bank.md), [`DsssBurstReceiver`: the burst chain, composed in C](../design/dsss-burst-receiver.md), [A Frame as a Description](../design/frame-description.md), [Design](../design/index.md), [MPSK Receiver](../design/mpsk.md), [Receiver Test Harness](../design/rx-test.md), [Telemetry — zero-cost scalar taps for running pipelines](../design/telemetry.md), [One home for the waveform enum tables](../design/waveform-enum-ssot.md), [Waveform amplitude & composition](../design/wfmgen-composition.md), [wfmgen — the waveform generator](../design/wfmgen.md)
