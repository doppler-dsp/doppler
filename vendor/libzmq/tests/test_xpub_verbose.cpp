...
void
create_xpub_with_2_subs (void **pub_, void **sub0_, void **sub1_)
{
...
void
create_duplicate_subscription (void *pub_, void *sub0_, void *sub1_)
{
  //  Subscribe for A
  TEST_ASSERT_SUCCESS_ERRNO (
...
test_xpub_verbose_two_subs ()
{
  ...
  // Subscribe socket for B instead
  TEST_ASSERT_SUCCESS_ERRNO (zmq_setsockopt (sub0, ZMQ_SUBSCRIBE, topic_b, 1));
  ...
  // Subscribe socket for A again
  TEST_ASSERT_SUCCESS_ERRNO (zmq_setsockopt (sub1, ZMQ_SUBSCRIBE, topic_a, 1));
...
test_xpub_verboser_two_subs ()
{
  ...
  // Subscribe socket for A again
  TEST_ASSERT_SUCCESS_ERRNO (zmq_setsockopt (sub0, ZMQ_SUBSCRIBE, topic_a, 1));
