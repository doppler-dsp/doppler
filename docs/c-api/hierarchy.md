...
* **struct** [**channel\_state\_t**](structchannel__state__t.md) _Tracking-channel state._ 
...
* **struct** [**ppe\_state\_t**](structppe__state__t.md) _PolyPhaseEstimator state (FFT plan + rate grid + scratch)._ 
