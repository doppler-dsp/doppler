...
static int
CellAsyncDsssReceiverObj_init (CellAsyncDsssReceiverObject *self,
                               PyObject *args, PyObject *kwds)
{
  ...
  unsigned long long correct_periods_raw  = 154;
  double             gain                 = 0.125;
  unsigned long long pullin_intervals_raw = 4;

  if (!PyArg_ParseTupleAndKeywords (
          args, kwds, "O|ddKidddKKiddKdK", kwlist, &code_obj, &chip_rate,
          &symbol_rate, &spc_raw, &m, &cn0_dbhz, &pfa, &pd, &segments_raw,
          &sps_raw, &differential, &carrier_freq_hz, &lost_confirm_s,
          &correct_periods_raw, &gain, &pullin_intervals_raw))
    return -1;
...
static PyObject *
CellAsyncDsssReceiverObj_steps_max_out (CellAsyncDsssReceiverObject *self,
...
static PyObject *
CellAsyncDsssReceiverObj_steps (CellAsyncDsssReceiverObject *self,
                                PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
CellAsyncDsssReceiverObj_seed (CellAsyncDsssReceiverObject *self,
                               PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
  ...
  if (!CellAsyncDsssReceiverObj_status_type)
    {
      CellAsyncDsssReceiverObj_status_type
          = PyStructSequence_NewType (&CellAsyncDsssReceiverObj_status_desc);
      if (!CellAsyncDsssReceiverObj_status_type)
        return NULL;
    }
...
static PyObject *
CellAsyncDsssReceiverObj_configure_lock_raw (CellAsyncDsssReceiverObject *self,
                                             PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
CellAsyncDsssReceiverObj_configure_chain_raw (
    CellAsyncDsssReceiverObject *self, PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
CellAsyncDsssReceiverObj_reset (CellAsyncDsssReceiverObject *self,
                                PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
CellAsyncDsssReceiverObj_state_bytes (CellAsyncDsssReceiverObject *self,
                                      PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
CellAsyncDsssReceiverObj_get_state (CellAsyncDsssReceiverObject *self,
                                    PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
CellAsyncDsssReceiverObj_set_state (CellAsyncDsssReceiverObject *self,
                                    PyObject                    *arg)
{
  if (!self->handle)
    {
...
static PyObject *
CellAsyncDsssReceiver_getprop_tracking (CellAsyncDsssReceiverObject *self,
...
CellAsyncDsssReceiver_getprop_lock_threshold (
    CellAsyncDsssReceiverObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyGetSetDef CellAsyncDsssReceiver_getset[] = {
  ...
  { "lost", (getter)CellAsyncDsssReceiver_getprop_lost, NULL,
    ...
    NULL },
  { "doppler_hz", (getter)CellAsyncDsssReceiver_getprop_doppler_hz, NULL,
    ...
    NULL },
  { "cn0_dbhz_est", (getter)CellAsyncDsssReceiver_getprop_cn0_dbhz_est, NULL,
  ...
  { "n", (getter)CellAsyncDsssReceiver_getprop_n, NULL,
  ...
  { "norm_freq", (getter)CellAsyncDsssReceiver_getprop_norm_freq, NULL,
    ...
    "ramp error.\n",
    NULL },
  { "nco_freq", (getter)CellAsyncDsssReceiver_getprop_nco_freq, NULL,
    ...
    NULL },
  { "locked", (getter)CellAsyncDsssReceiver_getprop_locked, NULL,
    ...
    "down-count.\n",
    NULL },
  { "lock_metric", (getter)CellAsyncDsssReceiver_getprop_lock_metric, NULL,
    ...
    NULL },
  { "lock_threshold", (getter)CellAsyncDsssReceiver_getprop_lock_threshold,
    NULL,
    ...
    NULL },
  { "car_last_error", (getter)CellAsyncDsssReceiver_getprop_car_last_error,
    NULL,
    ...
    "debug.\n",
    NULL },
  { "car_nco_freq", (getter)CellAsyncDsssReceiver_getprop_car_nco_freq, NULL,
    ...
    "debug.\n",
    NULL },
  { "mpsk_last_error", (getter)CellAsyncDsssReceiver_getprop_mpsk_last_error,
    NULL,
    ...
    NULL },
  { "code_locked", (getter)CellAsyncDsssReceiver_getprop_code_locked, NULL,
...
static PyObject *
CellAsyncDsssReceiverObj_destroy (CellAsyncDsssReceiverObject *self,
                                  PyObject *Py_UNUSED (ignored))
{
  if (self->handle)
    {
...
static PyObject *
CellAsyncDsssReceiverObj_enter (CellAsyncDsssReceiverObject *self,
                                PyObject *Py_UNUSED (ignored))
{
  Py_INCREF (self);
  return (PyObject *)self;
...
static PyObject *
CellAsyncDsssReceiverObj_exit (CellAsyncDsssReceiverObject *self,
                               PyObject                    *args)
{
  (void)args;
  if (self->handle)
...
static PyMethodDef CellAsyncDsssReceiverObj_methods[] = {

  { "steps", (PyCFunction)(void *)CellAsyncDsssReceiverObj_steps,
    ...
    "True\n" },
  { "steps_max_out", (PyCFunction)CellAsyncDsssReceiverObj_steps_max_out,
    METH_NOARGS,
    "steps_max_out() -> int\n"
    "\n"
    ...
    "fewer.\n" },
  { "seed", (PyCFunction)(void *)CellAsyncDsssReceiverObj_seed,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "status", (PyCFunction)CellAsyncDsssReceiverObj_status, METH_VARARGS,
    ...
    "2046\n" },
  { "configure_lock_raw",
    (PyCFunction)(void *)CellAsyncDsssReceiverObj_configure_lock_raw,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "0\n" },
  { "configure_chain_raw",
    (PyCFunction)(void *)CellAsyncDsssReceiverObj_configure_chain_raw,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "reset", (PyCFunction)CellAsyncDsssReceiverObj_reset, METH_NOARGS,
    ...
    "(0, 0, 0.0)\n" },
  { "state_bytes", (PyCFunction)CellAsyncDsssReceiverObj_state_bytes,
    METH_NOARGS,
    ...
    "constant.\n"
    "\n"
    "Raises ``RuntimeError`` if the CellAsyncDsssReceiver has already been\n"
    "destroyed.\n"
    "\n"
    "Returns\n"
    "-------\n"
  ...
  { "get_state", (PyCFunction)CellAsyncDsssReceiverObj_get_state, METH_NOARGS,
  ...
  { "set_state", (PyCFunction)CellAsyncDsssReceiverObj_set_state, METH_O,
    ...
    "``RuntimeError`` if the CellAsyncDsssReceiver has already been\n"
    "destroyed.\n"
    "\n"
    "Parameters\n"
    "----------\n"
    ...
    "long.\n" },
  { "destroy", (PyCFunction)CellAsyncDsssReceiverObj_destroy, METH_NOARGS,
  ...
  { "__enter__", (PyCFunction)CellAsyncDsssReceiverObj_enter, METH_NOARGS,
  ...
  { "__exit__", (PyCFunction)CellAsyncDsssReceiverObj_exit, METH_VARARGS,
...
static PyTypeObject CellAsyncDsssReceiverObjType = {
  ...
  .tp_doc
  = "Create the receiver a searcher's cell drives: the cell mode, idle until\n"
    "seed(), with no refine and no code loop of its own.\n"
    "\n"
    "Parameters\n"
    "----------\n"
    "code : NDArray[np.uint8]\n"
    "    Spreading code, 0/1 chips.\n"
    ...
    "    Design C/N0, dB-Hz -- sizes the Dll's lock detector as the "
    "searching\n"
    "    flavor's.\n"
    "pfa : float, default 1e-3\n"
    "    Acquisition false-alarm probability (kept for the flavor's shared\n"
    "    config; no search runs).\n"
    "pd : float, default 0.9\n"
    "    Likewise.\n"
    "segments : int, default 4\n"
    "    Partial correlations per code period.\n"
    "sps : int, default 8\n"
    "    MpskReceiver's samples per symbol.\n"
    ...
    "    Code periods per correction (>= 1): in a pool, the searcher's block\n"
    "    depth.\n"
    "gain : float, default 0.125\n"
    "    The correction's gain, chips per chip of the interval-mean read, "
    "(0,\n"
    ...
    ">>> rx.idle\n"
    "1\n",
  .tp_methods = CellAsyncDsssReceiverObj_methods,
  .tp_getset  = CellAsyncDsssReceiver_getset,
  .tp_new     = CellAsyncDsssReceiverObj_new,
  .tp_init    = (initproc)CellAsyncDsssReceiverObj_init,
};
