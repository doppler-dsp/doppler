...
Lifted from [**dp\_hbdecim\_cf32\_t**](hbdecim_8h.md#typedef-dp_hbdecim_cf32_t) (c/src/hbdecim.c). Only the cf32 variant is ported; dp\_hbdecim\_r2cf32 (real-input D2) is a separate object and a separate session.
