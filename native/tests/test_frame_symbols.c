...
const jm_any_fn jm_bound_symbols_frame[] = {
    (jm_any_fn)dp_frame_create,
    (jm_any_fn)dp_frame_destroy,
    (jm_any_fn)dp_frame_bits_max_out,
    ...
    (jm_any_fn)dp_frame_add_hex,
    (jm_any_fn)dp_frame_add_value,
    (jm_any_fn)dp_frame_add_stage_over,
    (jm_any_fn)dp_frame_check,
    (jm_any_fn)dp_frame_deframe,
    (jm_any_fn)dp_frame_deframe_max_out,
    (jm_any_fn)dp_frame_n_fields,
    (jm_any_fn)dp_frame_n_stages,
    (jm_any_fn)dp_frame_field_off,
    (jm_any_fn)dp_frame_field_bits,
    (jm_any_fn)dp_frame_stage_first,
    (jm_any_fn)dp_frame_stage_bits,
};
