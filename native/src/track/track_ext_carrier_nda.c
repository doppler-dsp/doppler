...
static PyObject *
CarrierNdaObj_steps (CarrierNdaObject *self, PyObject *args)
{
  if (!self->handle)
    {
...
DP_PY_STATE_METHODS (CarrierNdaObj, CarrierNdaObject, self->handle,
                     carrier_nda)

static PyMethodDef CarrierNdaObj_methods[] = {

  { "steps", (PyCFunction)CarrierNdaObj_steps, METH_VARARGS,
    "steps(x) -> ndarray\n"
    "\n"
