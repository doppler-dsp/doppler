 ...
 */
/* ======================================================== */
/* MatchedDDCObject — wraps dp_ddc_state_t *       */
/* ======================================================== */
...
static PyObject *
MatchedDDCObj_execute_ctrl_push_max_out (MatchedDDCObject *self,
...
static PyMethodDef MatchedDDCObj_methods[] = {
  ...
  { "execute_ctrl_push_max_out",
    (PyCFunction)MatchedDDCObj_execute_ctrl_push_max_out, METH_NOARGS,
...
static PyTypeObject MatchedDDCObjType = {
  ...
  = "Create a DDC whose cascade's terminal stage IS a matched filter.\n"
    ...
    "    LO frequency in cycles/sample at the input rate, as "
    "dp_ddc_create().\n"
