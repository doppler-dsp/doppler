...
main (void)
{
  ...
  DP_CHECK (
      ALMOST_EQ (i8_to_f32_step (obj, INT8_MAX), 127.0f / 128.0f, 1e-6f));
  DP_CHECK (ALMOST_EQ (i8_to_f32_step (obj, INT8_MIN), -1.0f, 1e-6f));
  DP_CHECK (ALMOST_EQ (i8_to_f32_step (obj, 0), 0.0f, 1e-7f));
