/* test_acc_cf64_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_acc_cf64[];
...
#endif
#endif
const jm_any_fn jm_bound_symbols_acc_cf64[] = {
    (jm_any_fn)dp_acc_cf64_create,
    (jm_any_fn)dp_acc_cf64_destroy,
    (jm_any_fn)dp_acc_cf64_reset,
    (jm_any_fn)dp_acc_cf64_steps,
    (jm_any_fn)dp_acc_cf64_get_acc,
    (jm_any_fn)dp_acc_cf64_set_acc,
    (jm_any_fn)dp_acc_cf64_get,
    (jm_any_fn)dp_acc_cf64_dump,
    (jm_any_fn)dp_acc_cf64_madd,
    (jm_any_fn)dp_acc_cf64_add2d,
    (jm_any_fn)dp_acc_cf64_madd2d,
    (jm_any_fn)dp_acc_cf64_state_bytes,
    (jm_any_fn)dp_acc_cf64_get_state,
    (jm_any_fn)dp_acc_cf64_set_state,
};
