...
void
test_poller_exists_with_socket_on_zmq_ctx_term (const int socket_type_)
{
#ifdef ZMQ_HAVE_POLLER
...
main (void)
{
  ...
  RUN_TEST (
      test_poller_exists_with_socket_on_zmq_ctx_term_non_thread_safe_socket);
  RUN_TEST (test_poller_exists_with_socket_on_zmq_ctx_term_thread_safe_socket);
