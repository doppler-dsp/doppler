...
zmq::poll_t::handle_t
zmq::poll_t::add_fd (fd_t fd_, i_poll_events *events_)
{
  check_thread ();
...
void
zmq::poll_t::rm_fd (handle_t handle_)
{
  check_thread ();
...
void
zmq::poll_t::set_pollin (handle_t handle_)
{
  check_thread ();
  fd_t index = fd_table[handle_].index;
...
void
zmq::poll_t::reset_pollin (handle_t handle_)
{
  check_thread ();
  fd_t index = fd_table[handle_].index;
...
void
zmq::poll_t::set_pollout (handle_t handle_)
{
  check_thread ();
  fd_t index = fd_table[handle_].index;
...
void
zmq::poll_t::reset_pollout (handle_t handle_)
{
  check_thread ();
  fd_t index = fd_table[handle_].index;
