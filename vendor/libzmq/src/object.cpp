...
void
zmq::object_t::set_tid (uint32_t id_)
{
  _tid = id_;
}
...
void
zmq::object_t::process_command (const command_t &cmd_)
{
  switch (cmd_.type)
    {
...
int
zmq::object_t::register_endpoint (const char *addr_,
...
int
zmq::object_t::unregister_endpoint (const std::string &addr_,
...
void
zmq::object_t::unregister_endpoints (socket_base_t *socket_)
{
  return _ctx->unregister_endpoints (socket_);
}

zmq::endpoint_t
zmq::object_t::find_endpoint (const char *addr_) const
{
  return _ctx->find_endpoint (addr_);
}

void
zmq::object_t::pend_connection (const std::string &addr_,
...
void
zmq::object_t::connect_pending (const char *addr_,
...
void
zmq::object_t::destroy_socket (socket_base_t *socket_)
{
  _ctx->destroy_socket (socket_);
}

zmq::io_thread_t *
zmq::object_t::choose_io_thread (uint64_t affinity_) const
{
...
void
zmq::object_t::send_plug (own_t *destination_, bool inc_seqnum_)
{
  if (inc_seqnum_)
...
void
zmq::object_t::send_own (own_t *destination_, own_t *object_)
{
  destination_->inc_seqnum ();
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_attach (session_base_t *destination_, i_engine *engine_,
                            bool inc_seqnum_)
{
  if (inc_seqnum_)
    destination_->inc_seqnum ();
...
void
zmq::object_t::send_conn_failed (session_base_t *destination_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_bind (own_t *destination_, pipe_t *pipe_, bool inc_seqnum_)
{
  if (inc_seqnum_)
    destination_->inc_seqnum ();
...
void
zmq::object_t::send_activate_read (pipe_t *destination_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_activate_write (pipe_t *destination_, uint64_t msgs_read_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_hiccup (pipe_t *destination_, void *pipe_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_pipe_peer_stats (pipe_t *destination_,
...
void
zmq::object_t::send_pipe_stats_publish (own_t *destination_,
...
void
zmq::object_t::send_pipe_term (pipe_t *destination_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_pipe_term_ack (pipe_t *destination_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_pipe_hwm (pipe_t *destination_, int inhwm_, int outhwm_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_term_req (own_t *destination_, own_t *object_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_term (own_t *destination_, int linger_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_term_ack (own_t *destination_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_term_endpoint (own_t *destination_, std::string *endpoint_)
{
  command_t cmd;
  cmd.destination = destination_;
...
void
zmq::object_t::send_reap (class socket_base_t *socket_)
{
  command_t cmd;
...
void
zmq::object_t::send_inproc_connected (zmq::socket_base_t *socket_)
{
  command_t cmd;
...
void
zmq::object_t::process_own (own_t *)
{
  zmq_assert (false);
}

void
zmq::object_t::process_attach (i_engine *)
{
  zmq_assert (false);
}

void
zmq::object_t::process_bind (pipe_t *)
{
  zmq_assert (false);
}
...
void
zmq::object_t::process_activate_write (uint64_t)
{
  zmq_assert (false);
}
...
void
zmq::object_t::process_pipe_peer_stats (uint64_t, own_t *,
                                        endpoint_uri_pair_t *)
{
  zmq_assert (false);
}
...
void
zmq::object_t::process_pipe_stats_publish (uint64_t, uint64_t,
                                           endpoint_uri_pair_t *)
{
  zmq_assert (false);
}
...
void
zmq::object_t::process_term_req (own_t *)
{
  zmq_assert (false);
}
...
void
zmq::object_t::process_term_endpoint (std::string *)
{
  zmq_assert (false);
}

void
zmq::object_t::process_reap (class socket_base_t *)
{
  zmq_assert (false);
}
...
void
zmq::object_t::send_command (const command_t &cmd_)
{
