...
void
test_monitor_versioned_basic (bind_function_t bind_function_,
                              const char *expected_prefix_, int type_)
{
  ...
  TEST_ASSERT_NOT_EQUAL (0,
                         strcmp (client_local_address, client_remote_address));
...
#ifdef ZMQ_EVENT_PIPES_STATS
void
test_monitor_versioned_stats (bind_function_t bind_function_,
