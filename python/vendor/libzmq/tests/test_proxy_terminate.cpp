...
// The main thread simply starts a basic steerable proxy server, publishes some
// messages, and then waits for the server to terminate.
void
test_proxy_terminate ()
{
  ...
  // Start a secondary publisher which writes data to the SUB-PUSH server
  // socket
