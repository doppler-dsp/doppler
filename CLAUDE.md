...
`## Quick start` section is likewise generated, from `docs/index.md`'s, by
`scripts/gen_readme_quickstart.py` (same `make docs-relink`, same
never-hand-edit-between-markers rule — `<!-- quickstart:start -->`/`:end`);
