/* test_detector2d_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_detector2d[];
...
const jm_any_fn jm_bound_symbols_detector2d[] = {
  (jm_any_fn)detector2d_create,      (jm_any_fn)detector2d_destroy,
  (jm_any_fn)detector2d_reset,       (jm_any_fn)detector2d_push,
  (jm_any_fn)detector2d_state_bytes, (jm_any_fn)detector2d_get_state,
