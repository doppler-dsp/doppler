/* test_f32_buffer_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_f32_buffer[];
...
#endif
#endif
const jm_any_fn jm_bound_symbols_f32_buffer[] = {
    (jm_any_fn)dp_f32_create,
    (jm_any_fn)dp_f32_write_view,
    (jm_any_fn)dp_f32_write_some_view,
    (jm_any_fn)dp_f32_wait_view,
    (jm_any_fn)dp_f32_peek_view,
    (jm_any_fn)dp_f32_consume,
    (jm_any_fn)dp_f32_close,
    (jm_any_fn)dp_f32_reset,
    (jm_any_fn)dp_f32_destroy,
};
