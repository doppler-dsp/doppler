...
{
  ResampCf32Object *self
      = (ResampCf32Object *)type->tp_alloc (type, 0);
  if (self)
    self->handle = NULL;
...
/* reset() */
static PyObject *
ResampCf32_reset (ResampCf32Object *self,
...
/* rate -> float */
static PyObject *
ResampCf32_rate (ResampCf32Object *self,
                 PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    { PyErr_SetString (PyExc_RuntimeError, "destroyed"); return NULL; }
...
/* num_phases -> int */
static PyObject *
ResampCf32_num_phases (ResampCf32Object *self,
                       PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    { PyErr_SetString (PyExc_RuntimeError, "destroyed"); return NULL; }
...
/* num_taps -> int */
static PyObject *
ResampCf32_num_taps (ResampCf32Object *self,
                     PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    { PyErr_SetString (PyExc_RuntimeError, "destroyed"); return NULL; }
...
ResampCf32_execute (ResampCf32Object *self, PyObject *args)
{
  ...
  PyObject *result = PyArray_NewLikeArray (
      (PyArrayObject *)out_arr, NPY_CORDER, NULL, 0);
  Py_DECREF (result); /* we'll use slicing instead */

  PyObject *slice = PySlice_New (
      PyLong_FromLong (0), PyLong_FromSsize_t (trim), NULL);
...
/* context manager */
static PyObject *
ResampCf32_enter (ResampCf32Object *self,
                  PyObject *Py_UNUSED (ignored))
{
  Py_INCREF (self);
  return (PyObject *)self;
...
ResampCf32_exit (ResampCf32Object *self, PyObject *args)
{
  (void)args;
  if (self->handle)
    { dp_resamp_cf32_destroy (self->handle); self->handle = NULL; }
  Py_RETURN_NONE;
}

static PyMethodDef ResampCf32_methods[] = {
  {"reset",      (PyCFunction)ResampCf32_reset,
   METH_NOARGS,  "Zero history and reset phase accumulator."},
  {"rate",       (PyCFunction)ResampCf32_rate,
   METH_NOARGS,  "Return fs_out / fs_in."},
  {"num_phases", (PyCFunction)ResampCf32_num_phases,
   METH_NOARGS,  "Return number of polyphase branches (L)."},
  {"num_taps",   (PyCFunction)ResampCf32_num_taps,
   METH_NOARGS,  "Return taps per phase (N)."},
  {"execute",    (PyCFunction)ResampCf32_execute,
   METH_VARARGS, "execute(x) -> np.ndarray[complex64]"},
  {"__enter__",  (PyCFunction)ResampCf32_enter,
   METH_NOARGS,  NULL},
  {"__exit__",   (PyCFunction)ResampCf32_exit,
   METH_VARARGS, NULL},
  {NULL}
};
...
PyInit_dp_resamp (void)
{
  ...
  if (PyModule_AddObject (m, "ResampCf32",
                          (PyObject *)&ResampCf32Type) < 0)
    {
