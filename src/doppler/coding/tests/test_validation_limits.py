...
`coding`'s copy of the campaign's limits gate. Each object under
...
`doppler.coding`, and a shared collector would import every module's
...
from doppler.coding.tests.validation.interleaver import (
    validate as interleaver_validate,
)
from doppler.tests._validation_common import assert_renders

OBJECTS = {
    "interleaver": interleaver_validate,
}
