/* test_interp_table_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_interp_table[];
...
const jm_any_fn jm_bound_symbols_interp_table[] = {
  (jm_any_fn)interp_table_create,  (jm_any_fn)interp_table_destroy,
  (jm_any_fn)interp_table_reset,   (jm_any_fn)interp_table_execute_max_out,
