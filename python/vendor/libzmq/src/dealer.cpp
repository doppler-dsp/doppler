...
void
zmq::dealer_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
int
zmq::dealer_t::xsetsockopt (int option_, const void *optval_,
                            size_t optvallen_)
{
...
int
zmq::dealer_t::xsend (msg_t *msg_)
{
  return sendpipe (msg_, NULL);
}

int
zmq::dealer_t::xrecv (msg_t *msg_)
{
...
void
zmq::dealer_t::xread_activated (pipe_t *pipe_)
{
  _fq.activated (pipe_);
}

void
zmq::dealer_t::xwrite_activated (pipe_t *pipe_)
{
  _lb.activated (pipe_);
}

void
zmq::dealer_t::xpipe_terminated (pipe_t *pipe_)
{
...
int
zmq::dealer_t::sendpipe (msg_t *msg_, pipe_t **pipe_)
{
