 ...
 * dp_sample_type_t, converts each cf32 block to that type into a grow-on-demand
 * scratch buffer, and publishes it. POSIX-only (links the vendored zmq).
 */
...
enum { WT_CF32, WT_CF64, WT_CI32, WT_CI16, WT_CI8 };
...
wfm_zmq_sink_open(const char *endpoint, int sample_type)
{
    ...
    dp_sample_type_t dt;
    switch (sample_type) {
    case WT_CF32: dt = CF32; break;
    case WT_CF64: dt = CF64; break;
    case WT_CI32: dt = CI32; break;
    case WT_CI16: dt = CI16; break;
    case WT_CI8: dt = CI8; break;
    default: return NULL;
    }
