...
**Guides** — [Clock Doppler — a source that is moving](../guide/wfmgen/doppler.md), [Waveform Generator — `wfmgen`](../guide/wfmgen/index.md), [Recipes](../guide/wfmgen/recipes.md), [Scenes — multi-segment specs](../guide/wfmgen/scenes.md), [Waveforms](../guide/wfmgen/waveforms.md)
