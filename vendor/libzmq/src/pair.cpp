...
void
zmq::pair_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::pair_t::xpipe_terminated (pipe_t *pipe_)
{
  if (pipe_ == _pipe)
    {
      _pipe = NULL;
...
void
zmq::pair_t::xread_activated (pipe_t *)
{
...
void
zmq::pair_t::xwrite_activated (pipe_t *)
{
  //  There's just one pipe. No lists of active and inactive pipes.
  //  There's nothing to do here.
}
