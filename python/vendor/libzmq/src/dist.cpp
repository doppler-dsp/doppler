...
void
zmq::dist_t::attach (pipe_t *pipe_)
{
...
bool
zmq::dist_t::has_pipe (pipe_t *pipe_)
{
  std::size_t claimed_index = _pipes.index (pipe_);

  // If pipe claims to be outside the available index space it can't be in the
  // distributor.
...
void
zmq::dist_t::pipe_terminated (pipe_t *pipe_)
{
...
void
zmq::dist_t::activated (pipe_t *pipe_)
{
...
int
zmq::dist_t::send_to_all (msg_t *msg_)
{
  _matching = _active;
...
int
zmq::dist_t::send_to_matching (msg_t *msg_)
{
...
void
zmq::dist_t::distribute (msg_t *msg_)
{
