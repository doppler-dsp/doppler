...
zmq::xsub_t::xsub_t (class ctx_t *parent_, uint32_t tid_, int sid_)
    : socket_base_t (parent_, tid_, sid_), _verbose_unsubs (false),
      _has_message (false), _more_send (false), _more_recv (false),
      _process_subscribe (false), _only_first_subscribe (false)
{
...
void
zmq::xsub_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::xsub_t::xread_activated (pipe_t *pipe_)
{
  _fq.activated (pipe_);
}

void
zmq::xsub_t::xwrite_activated (pipe_t *pipe_)
{
  _dist.activated (pipe_);
}

void
zmq::xsub_t::xpipe_terminated (pipe_t *pipe_)
{
...
void
zmq::xsub_t::xhiccuped (pipe_t *pipe_)
{
...
int
zmq::xsub_t::xsetsockopt (int option_, const void *optval_, size_t optvallen_)
{
...
int
zmq::xsub_t::xgetsockopt (int option_, void *optval_, size_t *optvallen_)
{
...
void
zmq::xsub_t::send_subscription (unsigned char *data_, size_t size_, void *arg_)
{
