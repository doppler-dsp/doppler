...
struct options_t
{
  ...
  int set_curve_key (uint8_t *destination_, const void *optval_,
                     size_t optvallen_);
...
inline bool
get_effective_conflate_option (const options_t &options)
{
...
int do_getsockopt (void *optval_, size_t *optvallen_, const void *value_,
                   size_t value_len_);

template <typename T>
int
do_getsockopt (void *const optval_, size_t *const optvallen_, T value_)
{
...
int do_getsockopt (void *optval_, size_t *optvallen_,
                   const std::string &value_);

int do_setsockopt_int_as_bool_strict (const void *optval_, size_t optvallen_,
                                      bool *out_value_);

int do_setsockopt_int_as_bool_relaxed (const void *optval_, size_t optvallen_,
                                       bool *out_value_);
}
