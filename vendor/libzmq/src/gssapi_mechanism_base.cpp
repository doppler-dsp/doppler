...
zmq::gssapi_mechanism_base_t::gssapi_mechanism_base_t (
    ...
    : mechanism_base_t (session_, options_), send_tok (), recv_tok (),
      /// FIXME remove? in_buf (),
      target_name (GSS_C_NO_NAME), principal_name (NULL),
      maj_stat (GSS_S_COMPLETE), min_stat (0), init_sec_min_stat (0),
      ret_flags (0), gss_flags (GSS_C_MUTUAL_FLAG | GSS_C_REPLAY_FLAG),
...
int
zmq::gssapi_mechanism_base_t::encode_message (msg_t *msg_)
{
...
int
zmq::gssapi_mechanism_base_t::decode_message (msg_t *msg_)
{
...
int
zmq::gssapi_mechanism_base_t::produce_initiate (msg_t *msg_,
                                                void *token_value_,
...
int
zmq::gssapi_mechanism_base_t::produce_ready (msg_t *msg_)
{
...
int
zmq::gssapi_mechanism_base_t::process_ready (msg_t *msg_)
{
  if (do_encryption)
    {
...
const gss_OID
zmq::gssapi_mechanism_base_t::convert_nametype (int zmq_nametype)
{
  switch (zmq_nametype)
    {
...
int
zmq::gssapi_mechanism_base_t::acquire_credentials (char *service_name_,
                                                   gss_cred_id_t *cred_,
                                                   gss_OID name_type_)
{
  OM_uint32 maj_stat;
