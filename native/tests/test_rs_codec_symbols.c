...
const jm_any_fn jm_bound_symbols_rs_codec[] = {
    (jm_any_fn)dp_rs_codec_create,
    (jm_any_fn)dp_rs_codec_destroy,
    (jm_any_fn)dp_rs_codec_encode_max_out,
    (jm_any_fn)dp_rs_codec_encode,
    (jm_any_fn)dp_rs_codec_decode,
    (jm_any_fn)dp_rs_codec_syndromes_max_out,
    (jm_any_fn)dp_rs_codec_syndromes,
    (jm_any_fn)dp_rs_codec_codeword_ok,
    (jm_any_fn)dp_rs_codec_generator,
    (jm_any_fn)dp_rs_codec_get_n,
    (jm_any_fn)dp_rs_codec_get_k,
    (jm_any_fn)dp_rs_codec_get_e,
    (jm_any_fn)dp_rs_codec_get_nroots,
    (jm_any_fn)dp_rs_codec_get_symbol_bits,
};
