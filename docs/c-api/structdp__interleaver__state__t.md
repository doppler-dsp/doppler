...
# Struct dp\_interleaver\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_interleaver\_state\_t**](structdp__interleaver__state__t.md)
...
```C++
size_t dp_interleaver_state_t::cols;
```
...
```C++
size_t dp_interleaver_state_t::rows;
```
...
```C++
size_t dp_interleaver_state_t::unit_bits;
```
