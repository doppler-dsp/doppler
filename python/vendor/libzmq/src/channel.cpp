...
zmq::channel_t::~channel_t () { zmq_assert (!_pipe); }

void
zmq::channel_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::channel_t::xpipe_terminated (pipe_t *pipe_)
{
  if (pipe_ == _pipe)
    _pipe = NULL;
}
...
void
zmq::channel_t::xread_activated (pipe_t *)
{
...
void
zmq::channel_t::xwrite_activated (pipe_t *)
{
  //  There's just one pipe. No lists of active and inactive pipes.
  //  There's nothing to do here.
}
...
int
zmq::channel_t::xsend (msg_t *msg_)
{
...
int
zmq::channel_t::xrecv (msg_t *msg_)
{
