...
# Struct dp\_lockdet\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_lockdet\_state\_t**](structdp__lockdet__state__t.md)
...
```C++
uint32_t dp_lockdet_state_t::cnt;
```
...
```C++
double dp_lockdet_state_t::down_thresh;
```
...
```C++
uint32_t dp_lockdet_state_t::n_down;
```
...
```C++
uint32_t dp_lockdet_state_t::n_up;
```
...
```C++
double dp_lockdet_state_t::up_thresh;
```
