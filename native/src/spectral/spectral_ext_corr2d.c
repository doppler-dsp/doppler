  ...
  if (out_obj && out_obj != Py_None)
    {
       ...
       * here because this fragment stays hand-owned: corr2d_create takes
       * the reference's two dimensions split out, which a flat array
       * init-param cannot express. Keep in step with jm's generated form
       * (gh-581). */
