...
AGC_setprop_decim (AGCObject *self, PyObject *value, void *Py_UNUSED (closure))
{
  ...
  if (!PyArg_Parse (value, "K", &v))
    return -1;
  self->handle->decim = (size_t)(v ? v : 1ULL);
  return 0;
}
...
static PyGetSetDef AGC_getset[]
    = { { "gain_db", (getter)AGC_getprop_gain_db, NULL, NULL, NULL },
        ...
        { "loop_bw", (getter)AGC_getprop_loop_bw, (setter)AGC_setprop_loop_bw,
          NULL, NULL },
        { "alpha", (getter)AGC_getprop_alpha, (setter)AGC_setprop_alpha, NULL,
          NULL },
...
static PyModuleDef agc_moduledef = {
  PyModuleDef_HEAD_INIT, .m_name = "agc",   .m_doc = "Agc module.",
