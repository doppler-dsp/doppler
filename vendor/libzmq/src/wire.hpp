...
inline void
put_uint8 (unsigned char *buffer_, uint8_t value_)
{
  *buffer_ = value_;
}

inline uint8_t
get_uint8 (const unsigned char *buffer_)
{
  return *buffer_;
}

inline void
put_uint16 (unsigned char *buffer_, uint16_t value_)
{
...
inline uint16_t
get_uint16 (const unsigned char *buffer_)
{
...
inline void
put_uint32 (unsigned char *buffer_, uint32_t value_)
{
...
inline uint32_t
get_uint32 (const unsigned char *buffer_)
{
...
inline void
put_uint64 (unsigned char *buffer_, uint64_t value_)
{
...
inline uint64_t
get_uint64 (const unsigned char *buffer_)
{
