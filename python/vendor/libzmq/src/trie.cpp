...
bool
zmq::trie_t::add (unsigned char *prefix_, size_t size_)
{
...
bool
zmq::trie_t::rm (unsigned char *prefix_, size_t size_)
{
...
bool
zmq::trie_t::check (const unsigned char *data_, size_t size_) const
{
...
void
zmq::trie_t::apply (void (*func_) (unsigned char *data_, size_t size_,
                                   void *arg_),
                    void *arg_)
{
...
void
zmq::trie_t::apply_helper (unsigned char **buff_, size_t buffsize_,
                           size_t maxbuffsize_,
