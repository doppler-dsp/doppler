...
void
test_reconnect_ivl_against_pair_socket (const char *my_endpoint_, void *sb_)
{
...
void
test_reconnect_ivl_tcp (bind_function_t bind_function_)
{
...
void
test_bad_filter_string (const char *const filter_)
{
...
void
test_set_non_matching_and_clear ()
{
  void *bind_socket = test_context_socket (ZMQ_PAIR);
...
void
test_set_matching (const char *const filter_)
{
  void *bind_socket = test_context_socket (ZMQ_PAIR);
