...
# Struct dp\_viterbi\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_viterbi\_state\_t**](structdp__viterbi__state__t.md)
...
Allocate with [**dp\_viterbi\_create()**](viterbi__core_8h.md#function-dp_viterbi_create). 
...
```C++
conv_code_t dp_viterbi_state_t::code;
```
...
```C++
uint8_t* dp_viterbi_state_t::dec;
```
...
```C++
size_t dp_viterbi_state_t::depth;
```
...
```C++
size_t dp_viterbi_state_t::fill;
```
...
```C++
size_t dp_viterbi_state_t::head;
```
...
```C++
unsigned* dp_viterbi_state_t::inbit;
```
...
```C++
uint32_t dp_viterbi_state_t::nstate;
```
...
```C++
unsigned* dp_viterbi_state_t::out0;
```
...
```C++
unsigned* dp_viterbi_state_t::out1;
```
...
```C++
uint32_t* dp_viterbi_state_t::pred0;
```
...
```C++
uint32_t* dp_viterbi_state_t::pred1;
```
