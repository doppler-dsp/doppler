...
void
msg_send_expect_success (void *s_, const char *group_, const char *body_)
{
  zmq_msg_t msg;
...
void
msg_recv_cmp (void *s_, const char *group_, const char *body_)
{
  zmq_msg_t msg;
  const size_t len = strlen (body_);
...
void
test_radio_dish_tcp_poll (int ipv6_)
{
  size_t len = MAX_SOCKET_STRING;
  char my_endpoint[MAX_SOCKET_STRING];
...
void
test_dish_connect_fails (int ipv6_)
{
  void *dish = test_context_socket (ZMQ_DISH);
...
void
test_radio_bind_fails (int ipv6_)
{
  void *radio = test_context_socket (ZMQ_RADIO);
...
static bool
is_multicast_available (int ipv6_)
{
...
static void
ignore_if_unavailable (int ipv6_)
{
...
static void
test_radio_dish_mcast (int ipv6_)
{
...
static void
test_radio_dish_no_loop (int ipv6_)
{
#ifdef _WIN32
  TEST_IGNORE_MESSAGE (
