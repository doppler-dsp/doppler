...
# Struct dp\_carrier\_nda\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_carrier\_nda\_state\_t**](structdp__carrier__nda__state__t.md)
...
| Type | Name |
| ---: | :--- |
|  [**dp\_boxcar\_state\_t**](structdp__boxcar__state__t.md) | [**arm**](#variable-arm)  <br> |
...
|  [**dp\_lockdet\_state\_t**](structdp__lockdet__state__t.md) | [**lockdet**](#variable-lockdet)  <br> |
|  int | [**m**](#variable-m)  <br> |
|  int | [**n**](#variable-n)  <br> |
...
```C++
dp_boxcar_state_t dp_carrier_nda_state_t::arm;
```
...
```C++
size_t dp_carrier_nda_state_t::arm_len;
```
...
```C++
double dp_carrier_nda_state_t::bn;
```
...
```C++
double dp_carrier_nda_state_t::ctl_cyc;
```
...
```C++
double dp_carrier_nda_state_t::last_error;
```
...
```C++
dp_loop_filter_state_t dp_carrier_nda_state_t::lf;
```
...
```C++
double dp_carrier_nda_state_t::lock;
```
...
```C++
dp_lockdet_state_t dp_carrier_nda_state_t::lockdet;
```
...
```C++
dp_lo_state_t dp_carrier_nda_state_t::nco;
```
...
```C++
double dp_carrier_nda_state_t::seed_norm_freq;
```
...
```C++
size_t dp_carrier_nda_state_t::sps;
```
...
```C++
carrier_nda_tlm_t dp_carrier_nda_state_t::tlm;
```
...
```C++
double dp_carrier_nda_state_t::zeta;
```
