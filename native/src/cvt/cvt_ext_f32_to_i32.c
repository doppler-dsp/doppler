/*
 * cvt_ext_f32_to_i32.c — F32ToI32 type for the cvt module.
 *
...
static PyObject *
F32ToI32Obj_new (PyTypeObject *type, PyObject *args, PyObject *kwds)
{
  F32ToI32Object *self = (F32ToI32Object *)type->tp_alloc (type, 0);
  if (self)
    self->handle = NULL;
...
static int
F32ToI32Obj_init (F32ToI32Object *self, PyObject *args, PyObject *kwds)
{
...
static PyObject *
F32ToI32Obj_reset (F32ToI32Object *self, PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
F32ToI32_step (F32ToI32Object *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
F32ToI32_steps (F32ToI32Object *self, PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
F32ToI32Obj_state_bytes (F32ToI32Object *self, PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
F32ToI32Obj_get_state (F32ToI32Object *self, PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
F32ToI32Obj_set_state (F32ToI32Object *self, PyObject *arg)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
F32ToI32_getprop_clipped (F32ToI32Object *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyGetSetDef F32ToI32_getset[]
    = { { "clipped", (getter)F32ToI32_getprop_clipped, NULL,
          "True if any sample has been saturated since the last reset().\n",
          NULL },
        { NULL } };

static PyObject *
F32ToI32Obj_destroy (F32ToI32Object *self, PyObject *Py_UNUSED (ignored))
{
  if (self->handle)
    {
      f32_to_i32_destroy (self->handle);
...
static PyObject *
F32ToI32Obj_enter (F32ToI32Object *self, PyObject *Py_UNUSED (ignored))
{
  Py_INCREF (self);
  return (PyObject *)self;
}
...
static PyObject *
F32ToI32Obj_exit (F32ToI32Object *self, PyObject *args)
{
  (void)args;
  if (self->handle)
    {
...
static PyMethodDef F32ToI32Obj_methods[] = {
  { "reset", (PyCFunction)F32ToI32Obj_reset, METH_NOARGS,
    ...
    ">>> c.clipped\n"
    "False\n" },
  { "step", (PyCFunction)F32ToI32_step, METH_VARARGS,
    "step(x) -> int32_t\n"
    "\n"
    ...
    "True\n"
    "\n" },
  { "steps", (PyCFunction)(void *)F32ToI32_steps, METH_VARARGS | METH_KEYWORDS,
    "steps(x[, out]) -> ndarray\n"
    "\n"
  ...
  { "state_bytes", (PyCFunction)F32ToI32Obj_state_bytes, METH_NOARGS,
  ...
  { "get_state", (PyCFunction)F32ToI32Obj_get_state, METH_NOARGS,
  ...
  { "set_state", (PyCFunction)F32ToI32Obj_set_state, METH_O,
    ...
    "long.\n" },
  { "destroy", (PyCFunction)F32ToI32Obj_destroy, METH_NOARGS,
  ...
  { "__enter__", (PyCFunction)F32ToI32Obj_enter, METH_NOARGS,
  ...
  { "__exit__", (PyCFunction)F32ToI32Obj_exit, METH_VARARGS,
...
static PyTypeObject F32ToI32ObjType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "cvt.F32ToI32",
  .tp_basicsize                           = sizeof (F32ToI32Object),
  .tp_dealloc                             = (destructor)F32ToI32Obj_dealloc,
  ...
  = "Create a f32_to_i32 instance.\n"
    ...
    "    2147483648.0f). Use 2^31 to convert a normalised `[-1, +1]` signal "
    "to\n"
  ...
  .tp_methods = F32ToI32Obj_methods,
  .tp_getset  = F32ToI32_getset,
  .tp_new     = F32ToI32Obj_new,
  .tp_init    = (initproc)F32ToI32Obj_init,
};
