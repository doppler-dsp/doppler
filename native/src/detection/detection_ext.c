...
static PyObject *
_bind_det_threshold_noncoherent (PyObject *self, PyObject *args,
                                 PyObject *kwds)
{
  (void)self;
...
_bind_det_pd_noncoherent (PyObject *self, PyObject *args, PyObject *kwds)
{
  ...
  int          n_noncoh  = 0;
  double       threshold = 0.0;
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "diid", _kwlist, &snr, &n_coh,
                                    &n_noncoh, &threshold))
    return NULL;
...
_bind_det_n_noncoh (PyObject *self, PyObject *args, PyObject *kwds)
{
  (void)self;
  static char *_kwlist[]
      = { "snr", "n_coh", "pd_min", "pfa", "max_n_noncoh", NULL };
  double snr          = 0.0;
  int    n_coh        = 0;
  double pd_min       = 0.0;
  double pfa          = 0.0;
  int    max_n_noncoh = 0;
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "diddi", _kwlist, &snr, &n_coh,
...
_bind_det_dwell_power (PyObject *self, PyObject *args, PyObject *kwds)
{
  ...
  double       pfa       = 0.0;
  int          max_dwell = 0;
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "dddi", _kwlist, &snr_power,
...
static PyMethodDef detection_module_methods[] = {
  { "marcum_q", (PyCFunction)(void *)_bind_marcum_q,
    ...
    "0.91811\n" },
  { "det_threshold", (PyCFunction)(void *)_bind_det_threshold,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "det_pd", (PyCFunction)(void *)_bind_det_pd, METH_VARARGS | METH_KEYWORDS,
    ...
    "1e-06\n" },
  { "det_dwell", (PyCFunction)(void *)_bind_det_dwell,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "84\n" },
  { "det_snr", (PyCFunction)(void *)_bind_det_snr,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "det_threshold_noncoherent",
    (PyCFunction)(void *)_bind_det_threshold_noncoherent,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "det_ema_alpha", (PyCFunction)(void *)_bind_det_ema_alpha,
    ...
    "50.5\n" },
  { "det_verify_count", (PyCFunction)(void *)_bind_det_verify_count,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "1\n" },
  { "det_verify_delay", (PyCFunction)(void *)_bind_det_verify_delay,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "13.2\n" },
  { "det_threshold_f", (PyCFunction)(void *)_bind_det_threshold_f,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "2.1931\n" },
  { "det_pd_noncoherent", (PyCFunction)(void *)_bind_det_pd_noncoherent,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "0.19\n" },
  { "det_n_noncoh", (PyCFunction)(void *)_bind_det_n_noncoh,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "1\n" },
  { "det_threshold_power", (PyCFunction)(void *)_bind_det_threshold_power,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "13.816\n" },
  { "det_pd_power", (PyCFunction)(void *)_bind_det_pd_power,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "0.9\n" },
  { "det_dwell_power", (PyCFunction)(void *)_bind_det_dwell_power,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "84\n" },
  { "det_snr_power", (PyCFunction)(void *)_bind_det_snr_power,
    METH_VARARGS | METH_KEYWORDS,
...
static PyModuleDef detection_moduledef = {
  ...
  .m_name = "detection",
  .m_doc
  = "Detection primitives: a portable lock detector (LockDet) applying level "
    "and time hysteresis to any scalar lock metric.\n"
    "\n"
    "Examples\n"
    "--------\n"
