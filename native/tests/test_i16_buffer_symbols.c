/* test_i16_buffer_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_i16_buffer[];
...
#endif
#endif
const jm_any_fn jm_bound_symbols_i16_buffer[] = {
    (jm_any_fn)dp_i16_create,
    (jm_any_fn)dp_i16_write_view,
    (jm_any_fn)dp_i16_write_some_view,
    (jm_any_fn)dp_i16_wait_view,
    (jm_any_fn)dp_i16_peek_view,
    (jm_any_fn)dp_i16_consume,
    (jm_any_fn)dp_i16_close,
    (jm_any_fn)dp_i16_reset,
    (jm_any_fn)dp_i16_destroy,
};
