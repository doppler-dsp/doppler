...
void
zmq::tune_vmci_buffer_size (ctx_t *context_, fd_t sockfd_,
                            uint64_t default_size_, uint64_t min_size_,
                            uint64_t max_size_)
{
...
#if defined ZMQ_HAVE_WINDOWS
void
zmq::tune_vmci_connect_timeout (ctx_t *context_, fd_t sockfd_, DWORD timeout_)
#else
void
zmq::tune_vmci_connect_timeout (ctx_t *context_, fd_t sockfd_,
...
zmq::fd_t
zmq::vmci_open_socket (const char *address_, const zmq::options_t &options_,
