...
void
zmq::server_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::server_t::xpipe_terminated (pipe_t *pipe_)
{
...
void
zmq::server_t::xread_activated (pipe_t *pipe_)
{
  _fq.activated (pipe_);
}

void
zmq::server_t::xwrite_activated (pipe_t *pipe_)
{
