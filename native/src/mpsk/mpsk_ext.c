...
static PyMethodDef mpsk_module_methods[] = {
    {"mpsk_map", (PyCFunction)(void *)_bind_mpsk_map, METH_VARARGS | METH_KEYWORDS,
     ...
     "True\n"},
    {"mpsk_demap", (PyCFunction)(void *)_bind_mpsk_demap, METH_VARARGS | METH_KEYWORDS,
    ...
    {"mpsk_diff_demap", (PyCFunction)(void *)_bind_mpsk_diff_demap, METH_VARARGS | METH_KEYWORDS,
     ...
     "True\n"},
    {"mpsk_bits_per_symbol", (PyCFunction)(void *)_bind_mpsk_bits_per_symbol, METH_VARARGS | METH_KEYWORDS,
...
static PyModuleDef mpsk_moduledef = {
    ...
    .m_name    = "mpsk",
    .m_doc     = "M-ary PSK mapping: hard and soft, including differential, symbol map/demap for BPSK, QPSK, and 8-PSK constellations.\n"
     "\n"
     "Examples\n"
     "--------\n"
     ">>> import numpy as np\n"
