/* bench_dsss_burst_receiver_core.c — no step() to benchmark */
...
main (void)
{
  dsss_burst_receiver_state_t *obj
      = dsss_burst_receiver_create (NULL, 0, NULL, 0, NULL, 0, 5, 4, 1000000.0,
                                    64, 50.0, 0.0, 1e-3, 0.9, 0.0, 0.0, 10);
  jm_bench_t _bench = { 0 };
