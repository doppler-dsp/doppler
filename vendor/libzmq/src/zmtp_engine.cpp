...
zmq::zmtp_engine_t::zmtp_engine_t (
    ...
    : stream_engine_base_t (fd_, options_, endpoint_uri_pair_, true),
      _greeting_size (v2_greeting_size), _greeting_bytes_read (0),
      _subscription_required (false), _heartbeat_timeout (0)
{
...
bool
zmq::zmtp_engine_t::handshake_v3_x (const bool downgrade_sub_)
{
  if (_options.mechanism == ZMQ_NULL
...
int
zmq::zmtp_engine_t::routing_id_msg (msg_t *msg_)
{
...
int
zmq::zmtp_engine_t::process_routing_id_msg (msg_t *msg_)
{
...
int
zmq::zmtp_engine_t::produce_ping_message (msg_t *msg_)
{
  // 16-bit TTL + \4PING == 7
...
int
zmq::zmtp_engine_t::produce_pong_message (msg_t *msg_)
{
  zmq_assert (_mechanism != NULL);
...
int
zmq::zmtp_engine_t::process_heartbeat_message (msg_t *msg_)
{
  if (msg_->is_ping ())
    {
      // 16-bit TTL + \4PING == 7
...
int
zmq::zmtp_engine_t::process_command_message (msg_t *msg_)
{
