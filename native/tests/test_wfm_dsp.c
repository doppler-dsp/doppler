...
main(void)
{
    ...
    if (check_rrc(0.0, 4, 6)) return 1;
    if (check_rrc(0.35, 8, 8)) return 1;
    if (check_rrc(0.25, 4, 6)) return 1;
    if (check_rrc(0.5, 4, 6)) return 1;
    ...
    printf("test_wfm_dsp: OK (rrc unit-energy/symmetric, dsss spread/despread)\n");
    return 0;
}
