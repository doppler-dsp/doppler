...
> [docs/dev/contributing/module-layout.md](../../dev/contributing/module-layout.md). For a step-by-step
> guide to adding a new module see
> [docs/dev/contributing/adding-a-module.md](../../dev/contributing/adding-a-module.md).
