/* test_fir_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_fir[];
...
const jm_any_fn jm_bound_symbols_fir[] = {
  (jm_any_fn)fir_create,          (jm_any_fn)fir_create_real,
  (jm_any_fn)fir_reset,           (jm_any_fn)fir_state_bytes,
  (jm_any_fn)fir_get_state,       (jm_any_fn)fir_set_state,
  (jm_any_fn)fir_destroy,         (jm_any_fn)fir_get_is_real,
  (jm_any_fn)fir_execute_max_out, (jm_any_fn)fir_execute,
};
