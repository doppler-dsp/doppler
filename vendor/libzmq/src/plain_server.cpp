...
int
zmq::plain_server_t::next_handshake_command (msg_t *msg_)
{
  int rc = 0;
...
int
zmq::plain_server_t::process_handshake_command (msg_t *msg_)
{
  int rc = 0;
...
int
zmq::plain_server_t::process_hello (msg_t *msg_)
{
...
void
zmq::plain_server_t::produce_welcome (msg_t *msg_)
{
...
int
zmq::plain_server_t::process_initiate (msg_t *msg_)
{
...
void
zmq::plain_server_t::produce_ready (msg_t *msg_) const
{
  make_command_with_basic_properties (msg_, ready_prefix, ready_prefix_len);
}

void
zmq::plain_server_t::produce_error (msg_t *msg_) const
{
...
void
zmq::plain_server_t::send_zap_request (const std::string &username_,
