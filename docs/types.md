...
| C99 type | Header | Bytes | Alias | NumPy | Rust |
| -------- | ------ | ----- | ----- | ----- | ---- |
| `float` | — | 4 | F32 | `np.float32` | `f32` |
| `double` | — | 8 | F64 | `np.float64` | `f64` |
| `int8_t` | `<stdint.h>` | 1 | CI8 | `np.int8` | `i8` |
| `int16_t` | `<stdint.h>` | 2 | CI16 | `np.int16` | `i16` |
| `int32_t` | `<stdint.h>` | 4 | CI32 | `np.int32` | `i32` |
| `uint32_t` | `<stdint.h>` | 4 | UI32 | `np.uint32` | `u32` |
| `uint64_t` | `<stdint.h>` | 8 | UI64 | `np.uint64` | `u64` |
| `float _Complex` | `<complex.h>` | 8 | CF32 | `np.complex64` | `DpCf32` |
| `double _Complex` | `<complex.h>` | 16 | CF64 | `np.complex128` | `Complex64` |
| `long double _Complex` | `<complex.h>` | 32 | CF128 | `np.clongdouble` | — |
