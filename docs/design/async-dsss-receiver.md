...
loop holds the emitter at its own jitter with no truth in the loop (§12.23),
or at a gain of an eighth on the correction, 2.5× under it (§12.24). What the hold cannot tell apart is
