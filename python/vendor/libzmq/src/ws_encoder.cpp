...
zmq::ws_encoder_t::~ws_encoder_t () { _masked_msg.close (); }

void
zmq::ws_encoder_t::message_ready ()
{
  int offset = 0;
  ...
  if (_must_mask)
    {
      ...
      //  If msg is shared or data is constant we cannot mask in-place,
      //  allocate a new msg for it
