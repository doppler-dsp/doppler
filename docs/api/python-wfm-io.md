...
**Design** — [Capture files — one reader, one writer, four containers](../design/capture-files.md), [Design](../design/index.md), [Telemetry — zero-cost scalar taps for running pipelines](../design/telemetry.md), [wfmgen — the stimulus generator](../design/wfmgen.md)
