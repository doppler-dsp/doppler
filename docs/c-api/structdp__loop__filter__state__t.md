...
# Struct dp\_loop\_filter\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_loop\_filter\_state\_t**](structdp__loop__filter__state__t.md)
...
```C++
double dp_loop_filter_state_t::bn;
```
...
```C++
double dp_loop_filter_state_t::integ;
```
...
```C++
double dp_loop_filter_state_t::ki;
```
...
```C++
double dp_loop_filter_state_t::kp;
```
...
```C++
double dp_loop_filter_state_t::t;
```
...
```C++
double dp_loop_filter_state_t::zeta;
```
