...
def _make_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "--type",
        choices=["tone", "noise", "pn", "bpsk", "qpsk"],
        default="tone",
    ...
    p.add_argument(
        "--sample_type",
        choices=["cf32", "cf64", "ci32", "ci16", "ci8"],
        default="cf32",
...
def main() -> None:
    ...
    out = np.asarray(obj.steps(args.count), dtype=np.complex64)
