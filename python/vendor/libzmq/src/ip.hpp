...
// Initialize network subsystem. May be called multiple times. Each call must
// be matched by a call to shutdown_network.
bool initialize_network ();

// Shutdown network subsystem. Must be called once for each call to
// initialize_network before terminating.
