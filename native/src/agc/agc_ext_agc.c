...
static PyGetSetDef AGC_getset[] = {
    { "gain_db",
      (getter)AGC_getprop_gain_db, NULL,
      ...
      NULL },
    { "applied_gain_db",
      (getter)AGC_getprop_applied_gain_db, NULL,
      ...
      NULL },
    { "ref_db",
      (getter)AGC_getprop_ref_db, (setter)AGC_setprop_ref_db,
      ...
      NULL },
    { "loop_bw",
      (getter)AGC_getprop_loop_bw, (setter)AGC_setprop_loop_bw,
      ...
      NULL },
    { "alpha",
      (getter)AGC_getprop_alpha, (setter)AGC_setprop_alpha,
      ...
      NULL },
    { "decim",
      (getter)AGC_getprop_decim, (setter)AGC_setprop_decim,
      ...
      NULL },
    { "clip_db",
      (getter)AGC_getprop_clip_db, (setter)AGC_setprop_clip_db,
