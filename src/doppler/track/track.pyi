...
class BpskReceiver:
    ...
    bn_timing : float, default 0.01
        ...
        design axis.
    acq_to_track : int, default 0
        Hand the carrier over to a decision-directed discriminator once locked.
    differential : int, default 0
...
class ContinuousMpskReceiver:
    ...
    m : int, default 2
        Constellation order M, 2/4/8 (default 4 = QPSK).
    sps : float, default 8.0
        Samples per symbol; any double >= m_out (8.0 by default, but 17.33389
        is equally valid).
    pulse : Literal["iandd", "rrc"], default "iandd"
        Matched-filter shape (default MPSK_RX_PULSE_IANDD).
    rrc_beta : float, default 0.35
    ...
    def __enter__(self) -> "ContinuousMpskReceiver":
        """Enter a context manager, returning this object.

        Lets a ContinuousMpskReceiver be used in a `with` statement so its C
    ...
    def __exit__(
        ...
        """Exit a context manager, releasing the ContinuousMpskReceiver.
