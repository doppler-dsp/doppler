...
typedef struct
{
  PyObject_HEAD f64_buffer_state_t *handle;
      ...
      switch (dp_f64_wait_status (self->handle, n))
        ...
        case DP_WAIT_TOO_LARGE:
          PyErr_Format (
              ...
              (long long)n, (long long)f64_buffer_get_capacity (self->handle));
          return NULL;
        case DP_WAIT_CLOSED:
...
F64Buffer_getprop_capacity (F64BufferObject *self, void *Py_UNUSED (closure))
{
  ...
  return PyLong_FromUnsignedLongLong (
      (unsigned long long)f64_buffer_get_capacity (self->handle));
}
static PyObject *
F64Buffer_getprop_available (F64BufferObject *self, void *Py_UNUSED (closure))
{
  ...
  /* <<IMPLEMENT: return the computed or stored value>> */
  return PyLong_FromUnsignedLongLong (
      (unsigned long long)f64_buffer_get_available (self->handle));
}
static PyObject *
F64Buffer_getprop_space (F64BufferObject *self, void *Py_UNUSED (closure))
{
  ...
  /* <<IMPLEMENT: return the computed or stored value>> */
  return PyLong_FromUnsignedLongLong (
      (unsigned long long)f64_buffer_get_space (self->handle));
}
static PyObject *
F64Buffer_getprop_dropped (F64BufferObject *self, void *Py_UNUSED (closure))
{
  ...
  /* <<IMPLEMENT: return the computed or stored value>> */
  return PyLong_FromUnsignedLongLong (
      (unsigned long long)f64_buffer_get_dropped (self->handle));
}
static PyObject *
F64Buffer_getprop_closed (F64BufferObject *self, void *Py_UNUSED (closure))
{
  ...
  /* <<IMPLEMENT: return the computed or stored value>> */
  return PyBool_FromLong ((long)(f64_buffer_get_closed (self->handle)));
}
