...
void
str_send_to (void *s_, const char *content_, const char *address_)
{
...
void
str_recv_from (void *s_, char **ptr_content_, char **ptr_address_)
{
...
test_connect_fails ()
{
  ...
  TEST_ASSERT_FAILURE_ERRNO (ENOCOMPATPROTO, zmq_connect (socket, ENDPOINT_4));
