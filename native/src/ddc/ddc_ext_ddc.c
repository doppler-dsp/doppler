...
/* serializable (gh-400): state-blob triplet over the ddc C ABI, sibling to
 * reset.  Hand-added (this fragment is sacred — it carries the gh-219
 * independent-array execute); mirrors jm's generated form for the
 * `serializable` flag, which also emits the matching ddc.pyi stubs. */
static PyObject *
