...
class Report:
    ...
    # ── front matter ─────────────────────────────────────────────────
    def executive(self, title: str, takeaways: list[str]) -> None:
        ...
        **Nothing here may be time-varying.** `make validate-check`
        ...
        self.head.append(
            ...
            "measured from the C implementation through its own binding; "
            "nothing is modelled. Re-run to regenerate."
        )
        self.head.append("")
