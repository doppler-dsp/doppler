  ...
  union
  {
    struct
    {
      ...
      unsigned char unused[msg_t_size
                           - (sizeof (metadata_t *) + 2 + sizeof (uint32_t)
                              + sizeof (group_t))];
      unsigned char type;
      unsigned char flags;
      uint32_t routing_id;
    ...
    struct
    {
      ...
      unsigned char
          unused[msg_t_size
                 - (sizeof (metadata_t *) + sizeof (void *) + sizeof (size_t)
...
inline int
close_and_return (zmq::msg_t *msg_, int echo_)
{
...
inline int
close_and_return (zmq::msg_t msg_[], int count_, int echo_)
{
