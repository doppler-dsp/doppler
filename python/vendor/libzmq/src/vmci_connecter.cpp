...
void
zmq::vmci_connecter_t::process_term (int linger_)
{
...
void
zmq::vmci_connecter_t::out_event ()
{
  if (_connect_timer_started)
    {
      cancel_timer (connect_timer_id);
...
void
zmq::vmci_connecter_t::timer_event (int id_)
{
...
void
zmq::vmci_connecter_t::start_connecting ()
{
...
void
zmq::vmci_connecter_t::add_connect_timer ()
{
