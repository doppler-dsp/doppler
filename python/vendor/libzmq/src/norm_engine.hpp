...
private:
  ...
  public:
    ...
    void
    IncrementBufferCount (size_t count)
    {
      buffer_count += count;
    }
    msg_t *
  ...
  fd_t wrapper_read_fd; // filedescriptor used to read norm events through the
                        // wrapper
