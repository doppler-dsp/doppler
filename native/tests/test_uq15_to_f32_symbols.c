/* test_uq15_to_f32_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_uq15_to_f32[];
...
#endif
#endif
const jm_any_fn jm_bound_symbols_uq15_to_f32[] = {
    (jm_any_fn)dp_uq15_to_f32_create,
    (jm_any_fn)dp_uq15_to_f32_destroy,
    (jm_any_fn)dp_uq15_to_f32_reset,
    (jm_any_fn)dp_uq15_to_f32_steps,
};
