...
int
zmq::ws_address_t::resolve (const char *name_, bool local_, bool ipv6_)
{
...
int
zmq::ws_address_t::to_string (std::string &addr_) const
{
  std::ostringstream os;
...
const sockaddr *
zmq::ws_address_t::addr () const
{
  return _address.as_sockaddr ();
}

socklen_t
zmq::ws_address_t::addrlen () const
{
  return _address.sockaddr_len ();
}

const char *
zmq::ws_address_t::host () const
{
  return _host.c_str ();
}

const char *
zmq::ws_address_t::path () const
{
  return _path.c_str ();
}
