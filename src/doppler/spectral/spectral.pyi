...
class Corr2D:
    ...
    """
    def __init__(self, ref: NDArray[Any] = ..., dwell: int = ..., nthreads: int = ...) -> None: ...
...
class Detector2D:
    ...
    """
    def __init__(self, ref: NDArray[Any] = ..., dwell: int = ..., noise_lo: int = ..., noise_hi: int = ..., noise_mode: Any = ..., threshold: float = ..., nthreads: int = ...) -> None: ...
