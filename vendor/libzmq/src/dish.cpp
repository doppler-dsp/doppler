...
void
zmq::dish_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::dish_t::xread_activated (pipe_t *pipe_)
{
  _fq.activated (pipe_);
}

void
zmq::dish_t::xwrite_activated (pipe_t *pipe_)
{
  _dist.activated (pipe_);
}

void
zmq::dish_t::xpipe_terminated (pipe_t *pipe_)
{
...
void
zmq::dish_t::xhiccuped (pipe_t *pipe_)
{
...
int
zmq::dish_t::xjoin (const char *group_)
{
...
int
zmq::dish_t::xleave (const char *group_)
{
  const std::string group = std::string (group_);
...
void
zmq::dish_t::send_subscriptions (pipe_t *pipe_)
{
...
int
zmq::dish_session_t::push_msg (msg_t *msg_)
{
  if (_state == group)
    {
...
int
zmq::dish_session_t::pull_msg (msg_t *msg_)
{
