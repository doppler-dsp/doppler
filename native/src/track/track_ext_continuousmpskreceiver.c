/*
 * track_ext_continuousmpskreceiver.c — ContinuousMpskReceiver type for the
 * track module.
 *
 ...
 */
/* ======================================================== */
/* ContinuousMpskReceiverObject — wraps mpsk_receiver_state_t *       */
/* ======================================================== */
...
} ContinuousMpskReceiverObject;

static void
ContinuousMpskReceiverObj_dealloc (ContinuousMpskReceiverObject *self)
{
  if (self->handle)
...
static PyObject *
ContinuousMpskReceiverObj_new (PyTypeObject *type, PyObject *args,
                               PyObject *kwds)
{
  ContinuousMpskReceiverObject *self
      = (ContinuousMpskReceiverObject *)type->tp_alloc (type, 0);
  if (self)
    self->handle = NULL;
...
static int
ContinuousMpskReceiverObj_init (ContinuousMpskReceiverObject *self,
                                PyObject *args, PyObject *kwds)
{
  static char *kwlist[] = {
    "m",          "sps",       "pulse",          "rrc_beta",     "rrc_span",
    "bn_carrier", "bn_timing", "init_norm_freq", "differential", NULL
  };
  int         m              = 2;
  double      sps            = 8.0;
  ...
  if (!PyArg_ParseTupleAndKeywords (
          args, kwds, "|idsdidddi", kwlist, &m, &sps, &pulse_str, &rrc_beta,
          &rrc_span, &bn_carrier, &bn_timing, &init_norm_freq, &differential))
    return -1;
  int pulse = 0;
  ...
  self->handle = mpsk_receiver_create_continuous (
      m, sps, pulse, rrc_beta, rrc_span, bn_carrier, bn_timing, init_norm_freq,
      differential);
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_set_telemetry (ContinuousMpskReceiverObject *self,
                                         PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_steps_max_out (ContinuousMpskReceiverObject *self,
...
static PyObject *
ContinuousMpskReceiverObj_steps (ContinuousMpskReceiverObject *self,
                                 PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_bits_max_out (ContinuousMpskReceiverObject *self,
                                        PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_bits (ContinuousMpskReceiverObject *self,
                                PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_configure_lock (ContinuousMpskReceiverObject *self,
                                          PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_reset (ContinuousMpskReceiverObject *self,
                                 PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_state_bytes (ContinuousMpskReceiverObject *self,
                                       PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_get_state (ContinuousMpskReceiverObject *self,
                                     PyObject *Py_UNUSED (ignored))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_set_state (ContinuousMpskReceiverObject *self,
                                     PyObject                     *arg)
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_agc_gain_db (ContinuousMpskReceiverObject *self,
...
static PyObject *
ContinuousMpskReceiver_getprop_norm_freq (ContinuousMpskReceiverObject *self,
                                          void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static int
ContinuousMpskReceiver_setprop_norm_freq (ContinuousMpskReceiverObject *self,
                                          PyObject                     *value,
                                          void *Py_UNUSED (closure))
{
  if (!self->handle)
...
static PyObject *
ContinuousMpskReceiver_getprop_lock (ContinuousMpskReceiverObject *self,
                                     void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_zeta (ContinuousMpskReceiverObject *self,
                                     void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_num_phases (ContinuousMpskReceiverObject *self,
                                           void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_lock_thresh (ContinuousMpskReceiverObject *self,
                                            void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_bn_agc_ratio (
    ContinuousMpskReceiverObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
ContinuousMpskReceiver_getprop_lock_time (ContinuousMpskReceiverObject *self,
                                          void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_timing_rate (ContinuousMpskReceiverObject *self,
                                            void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_tracking (ContinuousMpskReceiverObject *self,
                                         void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_m (ContinuousMpskReceiverObject *self,
                                  void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_sps (ContinuousMpskReceiverObject *self,
                                    void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_m_out (ContinuousMpskReceiverObject *self,
                                      void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_clipped (ContinuousMpskReceiverObject *self,
                                        void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_lock_drop_thresh (
    ContinuousMpskReceiverObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_sync_lock_thresh (
    ContinuousMpskReceiverObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyObject *
ContinuousMpskReceiver_getprop_sync_lock_drop_thresh (
    ContinuousMpskReceiverObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
...
static PyGetSetDef ContinuousMpskReceiver_getset[] = {
  { "agc_gain_db", (getter)ContinuousMpskReceiver_getprop_agc_gain_db, NULL,
    ...
    NULL },
  { "norm_freq", (getter)ContinuousMpskReceiver_getprop_norm_freq,
    (setter)ContinuousMpskReceiver_setprop_norm_freq,
    ...
    NULL },
  { "lock", (getter)ContinuousMpskReceiver_getprop_lock, NULL,
    "EMA of the carrier lock signal.\n", NULL },
  { "zeta", (getter)ContinuousMpskReceiver_getprop_zeta, NULL,
    ...
    NULL },
  { "num_phases", (getter)ContinuousMpskReceiver_getprop_num_phases, NULL,
    ...
    "reported.\n",
    NULL },
  { "lock_thresh", (getter)ContinuousMpskReceiver_getprop_lock_thresh, NULL,
    ...
    NULL },
  { "bn_agc_ratio", (getter)ContinuousMpskReceiver_getprop_bn_agc_ratio, NULL,
    ...
    NULL },
  { "lock_time", (getter)ContinuousMpskReceiver_getprop_lock_time, NULL,
    ...
    NULL },
  { "timing_rate", (getter)ContinuousMpskReceiver_getprop_timing_rate, NULL,
    ...
    NULL },
  { "tracking", (getter)ContinuousMpskReceiver_getprop_tracking, NULL,
    "0 = NDA acquire, 1 = decision.\n", NULL },
  { "m", (getter)ContinuousMpskReceiver_getprop_m, NULL,
    "constellation order M (2, 4, 8).\n", NULL },
  { "sps", (getter)ContinuousMpskReceiver_getprop_sps, NULL,
    "samples per symbol at the receiver's input.\n", NULL },
  { "m_out", (getter)ContinuousMpskReceiver_getprop_m_out, NULL,
    "Terminal outputs per symbol (the old `n`, now the cascade's).\n", NULL },
  { "clipped", (getter)ContinuousMpskReceiver_getprop_clipped, NULL,
    ...
    NULL },
  { "lock_drop_thresh",
    (getter)ContinuousMpskReceiver_getprop_lock_drop_thresh, NULL,
    ...
    NULL },
  { "sync_lock_thresh",
    (getter)ContinuousMpskReceiver_getprop_sync_lock_thresh, NULL,
  ...
  { "sync_lock_drop_thresh",
    (getter)ContinuousMpskReceiver_getprop_sync_lock_drop_thresh, NULL,
...
static PyObject *
ContinuousMpskReceiverObj_destroy (ContinuousMpskReceiverObject *self,
                                   PyObject *Py_UNUSED (ignored))
{
  if (self->handle)
    {
...
static PyObject *
ContinuousMpskReceiverObj_enter (ContinuousMpskReceiverObject *self,
                                 PyObject *Py_UNUSED (ignored))
{
  Py_INCREF (self);
  return (PyObject *)self;
...
static PyObject *
ContinuousMpskReceiverObj_exit (ContinuousMpskReceiverObject *self,
                                PyObject                     *args)
{
  (void)args;
  if (self->handle)
...
static PyMethodDef ContinuousMpskReceiverObj_methods[] = {

  { "set_telemetry",
    (PyCFunction)(void *)ContinuousMpskReceiverObj_set_telemetry,
    ...
    "True\n" },
  { "steps", (PyCFunction)(void *)ContinuousMpskReceiverObj_steps,
    METH_VARARGS | METH_KEYWORDS,
    "steps(x) -> ndarray\n"
    "\n"
    ...
    "True\n" },
  { "steps_max_out", (PyCFunction)ContinuousMpskReceiverObj_steps_max_out,
    METH_NOARGS,
    "steps_max_out() -> int\n"
    "\n"
    ...
    "fewer.\n" },
  { "bits", (PyCFunction)(void *)ContinuousMpskReceiverObj_bits,
    METH_VARARGS | METH_KEYWORDS,
    "bits(x) -> ndarray\n"
    "\n"
    ...
    "0.0\n" },
  { "bits_max_out", (PyCFunction)ContinuousMpskReceiverObj_bits_max_out,
    METH_NOARGS,
    "bits_max_out() -> int\n"
    "\n"
    ...
    "fewer.\n" },
  { "configure_lock",
    (PyCFunction)(void *)ContinuousMpskReceiverObj_configure_lock,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "drop\n" },
  { "reset", (PyCFunction)ContinuousMpskReceiverObj_reset, METH_NOARGS,
    "reset() -> None\n"
    "\n"
    ...
    "True\n" },
  { "state_bytes", (PyCFunction)ContinuousMpskReceiverObj_state_bytes,
    METH_NOARGS,
    ...
    "constant.\n"
    "\n"
    "Raises ``RuntimeError`` if the ContinuousMpskReceiver has already been\n"
    "destroyed.\n"
    "\n"
    "Returns\n"
    "-------\n"
  ...
  { "get_state", (PyCFunction)ContinuousMpskReceiverObj_get_state, METH_NOARGS,
  ...
  { "set_state", (PyCFunction)ContinuousMpskReceiverObj_set_state, METH_O,
    ...
    "``RuntimeError`` if the ContinuousMpskReceiver has already been\n"
    "destroyed.\n"
    "\n"
    "Parameters\n"
    "----------\n"
    ...
    "long.\n" },
  { "destroy", (PyCFunction)ContinuousMpskReceiverObj_destroy, METH_NOARGS,
  ...
  { "__enter__", (PyCFunction)ContinuousMpskReceiverObj_enter, METH_NOARGS,
  ...
  { "__exit__", (PyCFunction)ContinuousMpskReceiverObj_exit, METH_VARARGS,
...
static PyTypeObject ContinuousMpskReceiverObjType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "track.ContinuousMpskReceiver",
  .tp_basicsize = sizeof (ContinuousMpskReceiverObject),
  .tp_dealloc   = (destructor)ContinuousMpskReceiverObj_dealloc,
  .tp_flags     = Py_TPFLAGS_DEFAULT,
  .tp_doc       = "ContinuousMpskReceiver type.\n",
  .tp_methods   = ContinuousMpskReceiverObj_methods,
  .tp_getset    = ContinuousMpskReceiver_getset,
  .tp_new       = ContinuousMpskReceiverObj_new,
  .tp_init      = (initproc)ContinuousMpskReceiverObj_init,
};
