...
_bind_kaiser_window (PyObject *self, PyObject *args, PyObject *kwds)
{
  ...
  PyObject    *w_obj     = NULL;
  float        beta      = 0.0f;
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "Of", _kwlist, &w_obj, &beta))
    return NULL;
...
_bind_find_peaks_f32 (PyObject *self, PyObject *args, PyObject *kwds)
{
  ...
  float              min_db      = 0.0f;
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "OKf", _kwlist, &db_obj,
                                    &n_peaks_raw, &min_db))
    return NULL;
  ...
  for (size_t _i = 0; _i < _n; _i++)
    {
      PyObject *_tup = Py_BuildValue (
          "(NN)", PyFloat_FromDouble ((double)_results[_i].freq_norm),
          PyFloat_FromDouble ((double)_results[_i].amplitude_db));
      if (!_tup)
        {
          free (_results);
          Py_DECREF (_lst);
...
static PyMethodDef spectral_module_methods[] = {
  { "kaiser_enbw", (PyCFunction)(void *)_bind_kaiser_enbw,
    ...
    "1.7143\n" },
  { "kaiser_window", (PyCFunction)(void *)_bind_kaiser_window,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "kaiser_beta_for_sidelobe",
    (PyCFunction)(void *)_bind_kaiser_beta_for_sidelobe,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "0.0\n" },
  { "hann_window", (PyCFunction)(void *)_bind_hann_window,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "blackman_harris_window",
    (PyCFunction)(void *)_bind_blackman_harris_window,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "magnitude_db_cf32", (PyCFunction)(void *)_bind_magnitude_db_cf32,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "magnitude_db_cf64", (PyCFunction)(void *)_bind_magnitude_db_cf64,
    ...
    "[0.0, 20.0]\n" },
  { "find_peaks_f32", (PyCFunction)(void *)_bind_find_peaks_f32,
    METH_VARARGS | METH_KEYWORDS,
...
static PyModuleDef spectral_moduledef = {
  ...
  .m_name    = "spectral",
  .m_doc     = "Spectral transforms: reusable FFT and FFT2D engines (fixed "
               "length, pocketfft plans cached at construction) plus Corr / "
               "Corr2D cross-correlators and PSD power-spectrum estimators.\n"
               "\n"
               "Examples\n"
               "--------\n"
               ">>> import numpy as np\n"
...
{
  import_array ();
  if (PyType_Ready (&FFTObjType) < 0)
    return NULL;
  if (PyType_Ready (&FFT2DObjType) < 0)
    return NULL;
  if (PyType_Ready (&CorrObjType) < 0)
    return NULL;
  if (PyType_Ready (&Corr2DObjType) < 0)
    return NULL;
  if (PyType_Ready (&CorrDetectorObjType) < 0)
    return NULL;
  if (PyType_Ready (&CorrDetector2DObjType) < 0)
    return NULL;
  if (PyType_Ready (&PSDObjType) < 0)
    return NULL;
  ...
  if (PyModule_AddObject (m, "Corr2D", (PyObject *)&Corr2DObjType) < 0)
    {
      Py_DECREF (&Corr2DObjType);
      Py_DECREF (m);
      return NULL;
    }
  Py_INCREF (&CorrDetectorObjType);
  if (PyModule_AddObject (m, "CorrDetector", (PyObject *)&CorrDetectorObjType)
      < 0)
    {
      Py_DECREF (&CorrDetectorObjType);
      Py_DECREF (m);
      return NULL;
    }
  Py_INCREF (&CorrDetector2DObjType);
  if (PyModule_AddObject (m, "CorrDetector2D",
                          (PyObject *)&CorrDetector2DObjType)
      < 0)
    {
      Py_DECREF (&CorrDetector2DObjType);
      Py_DECREF (m);
      return NULL;
    }
