...
static PyGetSetDef DsssBurstReceiver_getset[] = {
  ...
  { "refine_span", (getter)DsssBurstReceiver_getprop_refine_span, NULL,
    ...
    "two\n"
    "differ by a whole burst plus the detection lag. **Read `min_gap` for "
    "the\n"
    "gap to leave**; it is derived from this reach (doppler#1172). How much "
    "the\n"
    "reach matters depends on the burst: at a 255-chip code, `reps=5`, "
    "`spc=2`\n"
    "it is 12240 samples, and 8316-sample bursts with 600 samples of dead "
    "air\n"
