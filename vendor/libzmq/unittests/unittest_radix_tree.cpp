...
bool
tree_add (zmq::radix_tree_t &tree_, const std::string &key_)
{
...
bool
tree_rm (zmq::radix_tree_t &tree_, const std::string &key_)
{
...
bool
tree_check (zmq::radix_tree_t &tree_, const std::string &key_)
{
...
void
return_key (unsigned char *data_, size_t size_, void *arg_)
{
