...
const jm_any_fn jm_bound_symbols_hbdecim_q15[] = {
  (jm_any_fn)hbdecim_q15_create,          (jm_any_fn)hbdecim_q15_destroy,
  (jm_any_fn)hbdecim_q15_reset,           (jm_any_fn)hbdecim_q15_execute,
  (jm_any_fn)hbdecim_q15_execute_max_out, (jm_any_fn)hbdecim_q15_get_rate,
  (jm_any_fn)hbdecim_q15_get_num_taps,    (jm_any_fn)hbdecim_q15_state_bytes,
  (jm_any_fn)hbdecim_q15_get_state,       (jm_any_fn)hbdecim_q15_set_state,
};
