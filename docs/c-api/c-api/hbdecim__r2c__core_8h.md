...
Lifted from [**dp\_hbdecim\_r2cf32\_t**](hbdecim_8h.md#typedef-dp_hbdecim_r2cf32_t) (c/src/hbdecim.c). Accepts real float32 input and produces CF32 IQ at half the input rate, with an embedded fs/4 frequency shift (same effect as mixing with e^{jπn/2} before decimating, at zero extra multiplications).
