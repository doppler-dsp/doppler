 ...
 */
/* ======================================================== */
/* FrameDescObject — wraps dp_frame_state_t *       */
/* ======================================================== */
...
static PyObject *
FrameDescObj_field_index (FrameDescObject *self, PyObject *args,
                          PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
FrameDescObj_name_field (FrameDescObject *self, PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
FrameDescObj_add_derived (FrameDescObject *self, PyObject *args,
                          PyObject *kwds)
{
  if (!self->handle)
    {
...
static PyObject *
FrameDescObj_deframe_max_out (FrameDescObject *self, PyObject *args)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
FrameDescObj_deframe (FrameDescObject *self, PyObject *args, PyObject *kwds)
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
FrameDesc_getprop_rx_ok (FrameDescObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
FrameDesc_getprop_rx_units (FrameDescObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
FrameDesc_getprop_rx_checked (FrameDescObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyObject *
FrameDesc_getprop_rx_symbols (FrameDescObject *self, void *Py_UNUSED (closure))
{
  if (!self->handle)
    {
      PyErr_SetString (PyExc_RuntimeError, "destroyed");
...
static PyGetSetDef FrameDesc_getset[] = {
  { "rx_ok", (getter)FrameDesc_getprop_rx_ok, NULL,
    ...
    NULL },
  { "rx_units", (getter)FrameDesc_getprop_rx_units, NULL,
    "Checks the last deframe() performed across every stage it reversed.\n",
    NULL },
  { "rx_checked", (getter)FrameDesc_getprop_rx_checked, NULL,
    ...
    NULL },
  { "rx_symbols", (getter)FrameDesc_getprop_rx_symbols, NULL,
...
static PyMethodDef FrameDescObj_methods[] = {
  ...
  { "add_stage", (PyCFunction)(void *)FrameDescObj_add_stage,
    ...
    "(32, 2040)\n" },
  { "field_index", (PyCFunction)(void *)FrameDescObj_field_index,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "-1\n" },
  { "name_field", (PyCFunction)(void *)FrameDescObj_name_field,
    METH_VARARGS | METH_KEYWORDS,
  ...
  { "deframe", (PyCFunction)(void *)FrameDescObj_deframe,
    METH_VARARGS | METH_KEYWORDS,
    ...
    "(0, 1)\n" },
  { "deframe_max_out", (PyCFunction)FrameDescObj_deframe_max_out, METH_VARARGS,
