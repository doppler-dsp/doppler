  ...
  {                                                                           \
    ...
    while ((event = get_monitor_event_with_timeout ((monitor), &err, NULL,    \
      ...
      {                                                                       \
        ...
        ++event_count;                                                        \
        /* TODO write this into a buffer and attach to the assertion msg      \
         * below */                                                           \
...
void setup_context_and_server_side (void **zap_control_, void **zap_thread_,
...
void shutdown_context_and_server_side (void *zap_thread_, void *server_,
...
void expect_new_client_bounce_fail (char *my_endpoint_, void *server_,
                                    socket_config_fn socket_config_,
                                    void *socket_config_data_,
                                    void **client_mon_ = NULL,
