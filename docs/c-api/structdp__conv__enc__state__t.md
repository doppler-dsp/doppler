...
# Struct dp\_conv\_enc\_state\_t



[**ClassList**](annotated.md) **>** [**dp\_conv\_enc\_state\_t**](structdp__conv__enc__state__t.md)
...
```C++
conv_code_t dp_conv_enc_state_t::code;
```
...
```C++
conv_enc_t dp_conv_enc_state_t::enc;
```
