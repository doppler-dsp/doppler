...
static PyMethodDef CarrierNdaObj_methods[] = {
  ...
  { "set_telemetry", (PyCFunction)(void *)CarrierNdaObj_set_telemetry,
    ...
    "probes on it. Registers four probes, emitted once per input sample (this "
    "is a sample-rate loop — use decim to thin the stream): "
    ...
    "starts stepping; the context is borrowed and must outlive the attachment "
