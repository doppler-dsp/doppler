...
void
zmq::client_t::xattach_pipe (pipe_t *pipe_, bool subscribe_to_all_,
...
void
zmq::client_t::xread_activated (pipe_t *pipe_)
{
  _fq.activated (pipe_);
}

void
zmq::client_t::xwrite_activated (pipe_t *pipe_)
{
  _lb.activated (pipe_);
}

void
zmq::client_t::xpipe_terminated (pipe_t *pipe_)
{
