...
static const char USAGE[]
    = "wfmgen - doppler waveform generator\n"
      ...
      "\n"
      "PULSE SHAPING\n"
      "  --pulse SHAPE   rect (default) or rrc (root-raised-cosine)\n"
