...
zmq::pollset_t::handle_t
zmq::pollset_t::add_fd (fd_t fd_, i_poll_events *events_)
{
...
void
zmq::pollset_t::rm_fd (handle_t handle_)
{
...
void
zmq::pollset_t::set_pollin (handle_t handle_)
{
  poll_entry_t *pe = (poll_entry_t *)handle_;
...
void
zmq::pollset_t::reset_pollin (handle_t handle_)
{
  poll_entry_t *pe = (poll_entry_t *)handle_;
...
void
zmq::pollset_t::set_pollout (handle_t handle_)
{
  poll_entry_t *pe = (poll_entry_t *)handle_;
...
void
zmq::pollset_t::reset_pollout (handle_t handle_)
{
  poll_entry_t *pe = (poll_entry_t *)handle_;
...
void
zmq::pollset_t::worker_routine (void *arg_)
{
  ((pollset_t *)arg_)->loop ();
}
