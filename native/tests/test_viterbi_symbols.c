...
const jm_any_fn jm_bound_symbols_viterbi[] = {
  (jm_any_fn)viterbi_create,    (jm_any_fn)viterbi_destroy,
  (jm_any_fn)viterbi_reset,     (jm_any_fn)viterbi_decode_max_out,
  (jm_any_fn)viterbi_decode,    (jm_any_fn)viterbi_state_bytes,
  (jm_any_fn)viterbi_get_state, (jm_any_fn)viterbi_set_state,
};
