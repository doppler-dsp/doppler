...
zmq::vmci_address_t::vmci_address_t (const sockaddr *sa, socklen_t sa_len,
                                     ctx_t *parent_)
    : parent (parent_)
{
...
int
zmq::vmci_address_t::resolve (const char *path_)
{
...
int
zmq::vmci_address_t::to_string (std::string &addr_) const
{
...
const sockaddr *
zmq::vmci_address_t::addr () const
{
  return reinterpret_cast<const sockaddr *> (&address);
}

socklen_t
zmq::vmci_address_t::addrlen () const
{
...
unsigned short
zmq::vmci_address_t::family () const
#else
sa_family_t
zmq::vmci_address_t::family () const
#endif
