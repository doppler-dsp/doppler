...
const jm_any_fn jm_bound_symbols_carrier_mpsk[] = {
    (jm_any_fn)dp_carrier_mpsk_create,
    (jm_any_fn)dp_carrier_mpsk_destroy,
    (jm_any_fn)dp_carrier_mpsk_reset,
    (jm_any_fn)dp_carrier_mpsk_state_bytes,
    (jm_any_fn)dp_carrier_mpsk_get_state,
    (jm_any_fn)dp_carrier_mpsk_set_state,
    (jm_any_fn)dp_carrier_mpsk_steps_max_out,
    (jm_any_fn)dp_carrier_mpsk_steps,
    (jm_any_fn)dp_carrier_mpsk_configure,
    (jm_any_fn)dp_carrier_mpsk_get_bn,
    (jm_any_fn)dp_carrier_mpsk_set_bn,
    (jm_any_fn)dp_carrier_mpsk_get_norm_freq,
    (jm_any_fn)dp_carrier_mpsk_set_norm_freq,
    (jm_any_fn)dp_carrier_mpsk_get_lock_metric,
    (jm_any_fn)dp_carrier_mpsk_get_last_error,
    (jm_any_fn)dp_carrier_mpsk_get_bn_fll,
    (jm_any_fn)dp_carrier_mpsk_set_bn_fll,
    (jm_any_fn)dp_carrier_mpsk_get_m,
};
