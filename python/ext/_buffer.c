...
static PyTypeObject F32BufferType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "_buffer.F32Buffer",
...
static PyTypeObject F64BufferType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "_buffer.F64Buffer",
...
static PyTypeObject I16BufferType = {
  PyVarObject_HEAD_INIT (NULL, 0).tp_name = "_buffer.I16Buffer",
