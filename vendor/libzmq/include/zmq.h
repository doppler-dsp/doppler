...
#define ZMQ_THREAD_SCHED_POLICY_DFLT -1
   ...
   * allocate zmq_msg_t on addresses aligned on a pointer-size boundary to
   * avoid this issue.
   */
...
#define ZMQ_HAVE_TIMERS
   ...
   */
  /*  about minutidp of time-related functions on different OS platforms. */
...
#define ZMQ_HAVE_POLLER
  ...
  ZMQ_EXPORT int zmq_poller_add_fd (void *poller, zmq_fd_t fd, void *user_data,
                                    short events);
  ZMQ_EXPORT int zmq_poller_modify_fd (void *poller, zmq_fd_t fd,
                                       short events);
