/* test_lockdet_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_lockdet[];
...
const jm_any_fn jm_bound_symbols_lockdet[] = {
  (jm_any_fn)lockdet_create,      (jm_any_fn)lockdet_destroy,
  (jm_any_fn)lockdet_configure,   (jm_any_fn)lockdet_reset,
  (jm_any_fn)lockdet_state_bytes, (jm_any_fn)lockdet_get_state,
  (jm_any_fn)lockdet_set_state,   (jm_any_fn)lockdet_steps,
};
