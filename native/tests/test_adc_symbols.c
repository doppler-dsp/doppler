/* test_adc_symbols.c -- generated by just-makeit (gh-1361).
 *
...
extern const jm_any_fn jm_bound_symbols_adc[];
...
const jm_any_fn jm_bound_symbols_adc[] = {
  (jm_any_fn)adc_create,      (jm_any_fn)adc_destroy,
  (jm_any_fn)adc_reset,       (jm_any_fn)adc_steps,
  (jm_any_fn)adc_state_bytes, (jm_any_fn)adc_get_state,
