 ...
 */
/* ======================================================== */
/* I16U64ToF32Object — wraps dp_i16u64_to_f32_state_t *       */
/* ======================================================== */
...
typedef struct
{
  PyObject_HEAD dp_i16u64_to_f32_state_t *handle;
} I16U64ToF32Object;
...
{
  if (self->handle)
    dp_i16u64_to_f32_destroy (self->handle);
...
I16U64ToF32Obj_init (I16U64ToF32Object *self, PyObject *args, PyObject *kwds)
{
  ...
  if (!PyArg_ParseTupleAndKeywords (args, kwds, "|f", kwlist, &scale))
    return -1;
  self->handle = dp_i16u64_to_f32_create (scale);
  if (!self->handle)
    {
      PyErr_SetString (PyExc_MemoryError,
                       "dp_i16u64_to_f32_create returned NULL");
      return -1;
    }
  return 0;
}
...
I16U64ToF32Obj_reset (I16U64ToF32Object *self, PyObject *Py_UNUSED (ignored))
{
  ...
  dp_i16u64_to_f32_reset (self->handle);
  Py_RETURN_NONE;
}
...
I16U64ToF32_step (I16U64ToF32Object *self, PyObject *args)
{
  ...
  float    y = dp_i16u64_to_f32_step (self->handle, x);
...
I16U64ToF32_steps (I16U64ToF32Object *self, PyObject *args, PyObject *kwds)
{
  ...
  if (out_obj && out_obj != Py_None)
    {
      ...
      dp_i16u64_to_f32_steps (self->handle,
  ...
  dp_i16u64_to_f32_steps (
      self->handle, (const uint64_t *)PyArray_DATA (in_arr),
      (float *)PyArray_DATA ((PyArrayObject *)out_arr), (size_t)n);
...
static PyMethodDef I16U64ToF32Obj_methods[] = {
  ...
  { "__enter__", (PyCFunction)I16U64ToF32Obj_enter, METH_NOARGS,
  ...
  { "__exit__", (PyCFunction)I16U64ToF32Obj_exit, METH_VARARGS,
