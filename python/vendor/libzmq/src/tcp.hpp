...
//  an error, retired_fd is returned, and the value of out_tcp_addr_ is
//  undefined. errno is set to an error code describing the cause of the error.
fd_t tcp_open_socket (const char *address_, const options_t &options_,
